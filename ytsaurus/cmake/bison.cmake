function(target_bison_parser Tgt Scope)
  foreach(arg ${ARGN})
    ...
    if (argPath MATCHES "${CMAKE_SOURCE_DIR}/ytsaurus/.*")
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND} -E env M4=${CMAKE_BINARY_DIR}/ytsaurus/bin/m4/bin/m4 ${CMAKE_BINARY_DIR}/ytsaurus/bin/bison/bin/bison ${BISON_FLAGS} -v --defines=${OutputDir}/${OutputBase}.h -o ${OutputDir}/${OutputBase}.cpp ${arg}
      DEPENDS ${arg}
    )
