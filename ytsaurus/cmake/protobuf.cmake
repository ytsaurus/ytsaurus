...
function(target_proto_plugin Tgt Name PluginTarget)
  set_property(TARGET ${Tgt} APPEND PROPERTY
    PROTOC_OPTS --${Name}_out=${CMAKE_BINARY_DIR}/ytsaurus/$<TARGET_PROPERTY:${Tgt},PROTO_NAMESPACE> --plugin=protoc-gen-${Name}=$<TARGET_FILE:${PluginTarget}>
  )
  set_property(TARGET ${Tgt} APPEND PROPERTY
...
function(target_proto_messages Tgt Scope)
  ...
  foreach(proto ${ARGN})
    if(proto MATCHES ${CMAKE_BINARY_DIR}/ytsaurus)
      file(RELATIVE_PATH protoRel ${CMAKE_BINARY_DIR}/ytsaurus ${proto})
    elseif (proto MATCHES ${CMAKE_SOURCE_DIR}/ytsaurus)
      file(RELATIVE_PATH protoRel ${CMAKE_SOURCE_DIR}/ytsaurus ${proto})
    else()
      set(protoRel ${proto})
    endif()
    get_filename_component(OutputBase ${protoRel} NAME_WLE)
    get_filename_component(OutputDir ${CMAKE_BINARY_DIR}/ytsaurus/${protoRel} DIRECTORY)
