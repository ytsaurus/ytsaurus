...
yt2 select 'project, region_sname, fielddate, hosts, visitors_per_host, puids, old_cookie_hits, visitors, luids, hits, spuids, old_cookie_visitors, hits_per_visitor from [//tmp/test] WHERE project="www.yandex.com.tr" AND region_sname="TOT"' --format yson
