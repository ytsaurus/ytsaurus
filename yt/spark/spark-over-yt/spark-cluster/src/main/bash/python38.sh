...
python3.8 -m pip install -i https://pypi.yandex-team.ru/simple ytsaurus-client==0.13.7
python3.8 -m pip install -i https://pypi.yandex-team.ru/simple pyarrow==12.0.1
