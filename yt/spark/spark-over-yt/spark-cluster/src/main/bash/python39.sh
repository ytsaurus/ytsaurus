...
$PYTHON_VERSION -m pip install -i https://pypi.yandex-team.ru/simple yandex-yt==0.12.2
$PYTHON_VERSION -m pip install -i https://pypi.yandex-team.ru/simple pyarrow==11.0.0
