...
COPY_FILE(yt/spark/spark-over-yt/spyt-package/src/main/bin/spark-shell-yt spark-shell-yt.py)
COPY_FILE(yt/spark/spark-over-yt/spyt-package/src/main/bin/spark-submit-yt spark-submit-yt.py)
