...
func convertMultiplexingBandOptions(opts *yt.MultiplexingBandOptions) *rpc_proxy.EMultiplexingBand {
	if opts == nil {
		return nil
	}
	...
	if opts.MultiplexingBand == nil {
		return nil
	}

	switch *opts.MultiplexingBand {
