...
type Config struct {
	...
	UploadStructure []string `json:"upload_structure" yson:"upload_structure"`

	// StdoutFile задаёт имя файла, куда будет сохранён stdout процесса.
	StdoutFile string `json:"stdout_file" yson:"stdout_file"`
	// StderrFile задаёт имя файла, куда будет сохранён stderr процесса.
	StderrFile string `json:"stderr_file" yson:"stderr_file"`
	...
	CoredumpDir string `json:"coredump_dir" yson:"coredump_dir"`

	// Ext4Dirs задаёт список директорий, которые будут расположены на ext4 файловой системе.
	Ext4Dirs []string `json:"ext4_dirs" yson:"ext4_dirs"`
	...
	Download map[string]string `json:"download" yson:"download"`
}
