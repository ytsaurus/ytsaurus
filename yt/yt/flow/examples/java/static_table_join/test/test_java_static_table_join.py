"""E2E test for the Java static-table-join companion."""
...
PIPELINE_CONFIG_PATH = yatest.common.source_path(
    "yt/yt/flow/examples/java/static_table_join/static_table_join/src/main/resources/pipeline.yson"
)
...
class TestStaticTableJoin(FlowTestJavaBase):
    JAVA_RUNNER_BINARY_DIR = yatest.common.binary_path(
        "yt/yt/flow/examples/java/static_table_join/static_table_join"
    )
