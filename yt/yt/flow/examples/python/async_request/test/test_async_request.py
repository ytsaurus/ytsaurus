"""E2E test for the Python async-request companion."""
...
PIPELINE_CONFIG_PATH = yatest.common.source_path(
    "yt/yt/flow/examples/python/async_request/test/pipeline.yson"
)
...
class TestAsyncRequest(FlowTestPythonBase):
    PYTHON_COMPANION_BINARY = yatest.common.binary_path(
        "yt/yt/flow/examples/python/async_request/async_request"
    )

    def setup_method(self, method):
        super(TestAsyncRequest, self).setup_method(method)
    ...
    def prepare_pipeline_config(self):
        ...
        pipeline_config["spec"]["computations"]["state"]["external_state_managers"]["/state"]["parameters"]["path"] = self.data_state
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(1, 1, id="1c_1w_stable"),
            pytest.param(4, 1, id="1c_4w_stable"),
        ],
    )
