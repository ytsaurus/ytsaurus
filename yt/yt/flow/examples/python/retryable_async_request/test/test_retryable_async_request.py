"""E2E test for the Python retryable-async-request companion."""
...
PIPELINE_CONFIG_PATH = yatest.common.source_path(
    "yt/yt/flow/examples/python/retryable_async_request/test/pipeline.yson"
)
...
class TestRetryableAsyncRequest(FlowTestPythonBase):
    PYTHON_COMPANION_BINARY = yatest.common.binary_path(
        "yt/yt/flow/examples/python/retryable_async_request/retryable_async_request"
    )

    def setup_method(self, method):
        super(TestRetryableAsyncRequest, self).setup_method(method)
