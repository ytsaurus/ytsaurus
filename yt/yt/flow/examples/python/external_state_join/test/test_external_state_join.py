"""E2E test for the Python external-state-join companion.
...
PIPELINE_CONFIG_PATH = yatest.common.source_path(
    "yt/yt/flow/examples/python/external_state_join/pipeline.yson"
)

#################################################################


class TestExternalStateJoin(FlowTestPythonBase):
    PYTHON_COMPANION_BINARY = yatest.common.binary_path(
        "yt/yt/flow/examples/python/external_state_join/external_state_join"
    )
