"""E2E test for the Go external-state-join companion.
...
class Test(FlowTestGoBase):
    GO_COMPANION_BINARY = yatest.common.binary_path("yt/yt/flow/examples/go/external_state_join/external_state_join")
