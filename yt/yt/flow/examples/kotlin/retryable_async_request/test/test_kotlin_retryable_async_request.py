...
PIPELINE_CONFIG_PATH = yatest.common.source_path(
    f"{yatest.common.context.project_path}/../retryable_async_request/src/main/resources/pipeline.yson"
)
...
class TestRetryableAsyncRequest(FlowTestJavaBase):
    JAVA_RUNNER_BINARY_DIR = yatest.common.binary_path(f"{yatest.common.context.project_path}/../retryable_async_request/")
    JAVA_RUNNER_MAIN_CLASS = "tech.ytsaurus.flow.examples.retryableasyncrequest.RunnerMain"
