"""E2E test for the Kotlin external-state-join companion.
...
PIPELINE_CONFIG_PATH = yatest.common.source_path(
    "yt/yt/flow/examples/kotlin/external_state_join/external_state_join/src/main/resources/pipeline.yson"
)
...
class TestExternalStateJoin(FlowTestJavaBase):
    JAVA_RUNNER_BINARY_DIR = yatest.common.binary_path(
        "yt/yt/flow/examples/kotlin/external_state_join/external_state_join"
    )
