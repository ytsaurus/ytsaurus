...
class TestUrlDownloader(FlowTestBase):
    FLOW_BINARY_PATH = yatest.common.binary_path(f"{yatest.common.context.project_path}/../url_downloader")
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(4, 1, True, id="1c_4w_unstable"),
        ],
    )
