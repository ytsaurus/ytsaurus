...
PIPELINE_CONFIG_PATH = yatest.common.source_path(
    f"{yatest.common.context.project_path}/pipeline/src/main/resources/pipeline.yson"
)
...
class TestReanimateVanillaJava(FlowTestJavaBase):
    JAVA_RUNNER_BINARY_DIR = yatest.common.binary_path(f"{yatest.common.context.project_path}/pipeline/")
    JAVA_MAIN_CLASS = "tech.ytsaurus.flow.examples.reanimate.ReanimateApplication"
    ...
    def test_reanimate(self):
        ...
        with self.start_flow_process_federation(
            ...
            # The Java companion must process messages and the secret must reach it: the mapper
