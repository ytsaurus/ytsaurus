...
def run_primary_yt_sync(cluster, folder, queue_tablet_count):
    queues = {
        "input_queue": {
            "default": {
    ...
    run_yt_sync(cluster, folder, stages_spec)


def run_remote_yt_sync(cluster, folder, queue_tablet_count):
    queues = {
        "output_queue": {
            "default": {
                "$merge_presets": ["builtin:table_preset"],
...
def run_yt_sync(cluster, folder, stages_spec):
    stages = {
        "default": {},
        "test": {
            "folder": folder,
