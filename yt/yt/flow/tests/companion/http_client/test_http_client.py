...
class TestCompanionHttpClient(FlowTestCppCompanionBase):
    CPP_COMPANION_BINARY = yatest.common.binary_path("yt/yt/flow/tests/companion/http_client/companion/companion")
    ...
    def prepare_pipeline_config(self, url, use_https_client):
        ...
        http_get["processing_function_parameters"]["url"] = url
        http_get["processing_function_parameters"]["use_https_client"] = use_https_client
    ...
    def test_http_clients_use_configured_settings(self, use_https_client):
        ...
        with RedirectingHttpServer() as http_server:
            ...
            client_config = {
                ...
                "omit_question_mark_for_empty_query": True,
            }
            if use_https_client:
