"""End-to-end type-checking test for the java companion: insert one row per
...
class Test(FlowTestJavaBase):
    ...
    JAVA_RUNNER_MAIN_CLASS = "tech.ytsaurus.flow.tests.types.RunnerMain"
    ...
    def test_types(self):
        ...
        with self.start_flow_process_federation(
            ...
            logging.info("java companion type-checking passed (rows=%d)", len(SAMPLE_ROWS))
