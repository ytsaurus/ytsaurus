...
from yt_commands import (
    authors, print_debug, raises_yt_error, set_node_banned, update_controller_agent_config, wait, wait_breakpoint, release_breakpoint, with_breakpoint, create,
...
for line in sys.stdin:
    ...
    def test_controller_survives_two_failed_jobs(self):
        ...
        def set_nodes_banned(nodes, flag):
            for node in nodes:
                set_node_banned(node, flag)
