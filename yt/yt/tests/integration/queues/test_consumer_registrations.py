<<<<<<< releases/yt/stable/23.1: Fixes for merged PRs (code beautifying)
=======
from .test_queue_agent import ReplicatedObjectBase
>>>>>>> cherry-pick: YT-19178: Add redirection to fallback replicas (replicated/chaos) for PullQueue/PullConsumer
