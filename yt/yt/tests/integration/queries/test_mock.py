...
class TestAccessControl(YTEnvSetup):
    ...
    def test_get_query_tracker_info(self, query_tracker):
        ...
        assert get_query_tracker_info() == \
            {'query_tracker_stage': 'production', 'cluster_name': 'primary', 'supported_features': supported_features, 'access_control_objects': ['everyone-share', 'nobody']}
        ...
        assert get_query_tracker_info(attributes=["access_control_objects"]) == \
            {'query_tracker_stage': 'production', 'cluster_name': '', 'supported_features': {}, 'access_control_objects': ['everyone-share', 'nobody']}

        assert get_query_tracker_info(stage='testing') == \
            {'query_tracker_stage': 'testing', 'cluster_name': 'primary', 'supported_features': supported_features, 'access_control_objects': ['everyone-share', 'nobody']}
