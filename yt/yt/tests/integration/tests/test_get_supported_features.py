...
class TestGetFeatures(YTEnvSetup):
    ...
    def test_get_features(self):
        ...
        assert expected_compression_codecs == \
            expected_compression_codecs.intersection(__builtin__.set(features["compression_codecs"]))
        ...
        assert expected_erasure_codecs == \
            expected_erasure_codecs.intersection(__builtin__.set(features["erasure_codecs"]))
