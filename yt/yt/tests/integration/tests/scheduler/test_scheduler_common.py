...
class TestControllerAgentCommunication(YTEnvSetup):
    NUM_MASTERS = 1
    NUM_NODES = 3
    NUM_SCHEDULERS = 1
    ...
    DELTA_SCHEDULER_CONFIG = {
        "scheduler": {
            "send_running_job_events": True,
        },
    }

    DELTA_NODE_CONFIG = {
        "exec_agent": {
            "scheduler_connector": {"heartbeat_period": 100},  # 1 msec
            "controller_agent_connector": {"heartbeat_period": 100},  # 1 msec
            "job_controller": {
                "resource_limits": {
                    "user_slots": 10,
                    "cpu": 100,
    ...
    @authors("pogorelov")
    def test_do_not_send_running_job_events(self):
