...
#include <yt/server/controller_agent/legacy_controllers/auto_merge_director.h>
...
TEST(TAutoMergeLegacyTest, SimpleScenario)
{
...
TEST(TAutoMergeLegacyTest, ForceFlush)
{
    TAutoMergeDirector director(
        20 /* maxIntermediateChunkCount */,
        5 /* maxChunkCountPerMergeJob */,
...
TEST(TAutoMergeLegacyTest, BypassMarginalJobs)
{
    TAutoMergeDirector director(
        20 /* maxIntermediateChunkCount */,
        5 /* maxChunkCountPerMergeJob */,
...
TEST(TAutoMergeLegacyTest, JobFailure)
{
    TAutoMergeDirector director(
        20 /* maxIntermediateChunkCount */,
        5 /* maxChunkCountPerMergeJob */,
