...
TEST_F(TChunkViewTest, TestRangesIntersection)
{
    ...
    EXPECT_EQ(K6, chunkView->GetAdjustedLowerReadLimit(TReadLimit(K5)).GetLegacyKey());
    EXPECT_EQ(K8, chunkView->GetAdjustedUpperReadLimit(TReadLimit(K9)).GetLegacyKey());
