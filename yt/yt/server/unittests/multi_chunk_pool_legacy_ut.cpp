...
class TMultiChunkPoolInputLegacyTest
    : public TMultiChunkPoolTestBase
{
protected:
    TMultiChunkPoolInputLegacyTest()
    {
...
TEST_F(TMultiChunkPoolInputLegacyTest, TestAdd)
{
...
TEST_F(TMultiChunkPoolInputLegacyTest, TestAddWithKey)
{
    TChunkStripeKey key;
...
TEST_F(TMultiChunkPoolInputLegacyTest, TestSuspend)
{
    InSequence sequence;
    EXPECT_CALL(*Mocks_[0], Add(Stripes_[0]))
        .WillOnce(Return(42));
...
TEST_F(TMultiChunkPoolInputLegacyTest, TestResume)
{
    InSequence sequence;
    EXPECT_CALL(*Mocks_[0], Add(Stripes_[0]))
        .WillOnce(Return(42));
...
TEST_F(TMultiChunkPoolInputLegacyTest, TestReset)
{
...
TEST_F(TMultiChunkPoolInputLegacyTest, TestFinish)
{
...
TEST_F(TMultiChunkPoolInputLegacyTest, TestFinishPool)
{
...
TEST_F(TMultiChunkPoolInputLegacyTest, TestPartitionTag)
{
...
TEST_F(TMultiChunkPoolInputLegacyTest, TestCookieMapping)
{
...
class TMultiChunkPoolOutputLegacyTest
    : public TMultiChunkPoolTestBase
{
protected:
    TMultiChunkPoolOutputLegacyTest() = default;
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestExtract)
{
    InitPools({3, 2, 1, 4});
    int cookieCount = 0;
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestEmptyPools1)
{
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestEmptyPools2)
{
    InitPools({0, 0, 0});
    int cookieCount = 0;
    while (!Pool_->IsCompleted()) {
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestEmptyPools3)
{
    InitPools({});
    int cookieCount = 0;
    while (!Pool_->IsCompleted()) {
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestTeleportChunks)
{
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestGetOutputOrder)
{
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestGetLocality)
{
    InitPools({0});
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestGetStripeList)
{
    InitPools({2, 1});
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestGetStripeListSliceCount)
{
    InitPools({2, 1});
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestCompleted)
{
    InitPools({2, 1});
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestFailed)
{
    InitPools({2, 1});
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestAborted)
{
    InitPools({2, 1});
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestLost)
{
    InitPools({2, 1});
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestStatistics)
{
    InitPools({2, 1});
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestCookieMapping)
{
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestFinalize)
{
...
TEST_F(TMultiChunkPoolOutputLegacyTest, TestAddPoolOutput)
{
