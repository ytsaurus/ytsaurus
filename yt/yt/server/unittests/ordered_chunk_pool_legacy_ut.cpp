...
#include <yt/server/lib/legacy_chunk_pools/output_order.h>
...
class TOrderedChunkPoolLegacyTest
    : public Test
{
protected:
...
TEST_F(TOrderedChunkPoolLegacyTest, OrderedMergeSimple)
{
    InitTables(
...
TEST_F(TOrderedChunkPoolLegacyTest, OrderedMergeOrderedOutput)
{
    InitTables(
        {true, true, true} /* isTeleportable */,
        {false, false, false} /* isVersioned */
...
TEST_F(TOrderedChunkPoolLegacyTest, OrderedMergeSliceLargeChunks)
{
    InitTables(
...
class TOrderedChunkPoolLegacyTestRandomized
    : public WithParamInterface<int>
    , public TOrderedChunkPoolLegacyTest
{
public:
    TOrderedChunkPoolLegacyTestRandomized() = default;

    virtual void SetUp() override final
    {
        TOrderedChunkPoolLegacyTest::SetUp();
        Gen_.seed(GetParam());
    }
};
...
TEST_P(TOrderedChunkPoolLegacyTestRandomized, VariousOperationsWithPoolTest)
{
    InitTables(
        {false} /* isTeleportable */,
        {false} /* isVersioned */
...
INSTANTIATE_TEST_SUITE_P(VariousOperationsWithPoolInstantiation,
    TOrderedChunkPoolLegacyTestRandomized,
