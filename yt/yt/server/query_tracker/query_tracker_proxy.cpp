    ...
    TTimestamp timestamp)
{
    ...
    auto asyncLookupResult = client->LookupRows(
        ...
        lookupOptions);
    auto asyncRecord = asyncLookupResult.Apply(BIND([=] (const IUnversionedRowsetPtr& result) {
        auto optionalRecords = ToOptionalRecords<typename TRecordDescriptor::TRecordPartial>(result);
