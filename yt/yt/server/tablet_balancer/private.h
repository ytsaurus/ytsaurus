...
YT_DEFINE_LEAKY_GLOBAL(const NLogging::TLogger, TabletBalancerLogger, "TabletBalancer");
YT_DEFINE_LEAKY_GLOBAL(const NLogging::TLogger, PivotKeysPickerLogger, "PivotKeysPicker");
YT_DEFINE_LEAKY_GLOBAL(const NProfiling::TProfiler, TabletBalancerProfiler, "/tablet_balancer");
