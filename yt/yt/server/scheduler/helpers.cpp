...
const std::vector<TStatisticsDescription>& GetOperationStatisticsDescriptions()
{
    static const std::vector<TStatisticsDescription> statisticsHints = {
        ...
        {"user_job/cpu_reserve", "Amount of CPU guaranteed to the user job at the time of start", "centi-cores"},
        ...
        {"user_job/gpu/cumulative_slowdown/hw_power_brake", "Time during which the GPU experienced hardware power brake slowdown", "ms"},
        {"user_job/gpu/cumulative_slowdown/hw_thermal", "Time during which the GPU experienced hardware thermal slowdown", "ms"},
