...
public:
    ...
    void UnregisterOperation(const IOperationPtr& operation) override
    {
        YT_ASSERT_INVOKERS_AFFINITY(FeasibleInvokers_);
    ...
    void DisableOperation(IOperation* operation) override
    {
        YT_ASSERT_INVOKERS_AFFINITY(FeasibleInvokers_);
    ...
    void BuildOperationInfoForEventLog(const IOperation* operation, TFluentMap fluent) override
    {
        YT_ASSERT_INVOKERS_AFFINITY(FeasibleInvokers_);
    ...
    void ApplyOperationRuntimeParameters(IOperation* operation) override
    {
        YT_ASSERT_INVOKERS_AFFINITY(FeasibleInvokers_);
    ...
    TFuture<void> ValidateOperationStart(const IOperation* operation) override
    {
    ...
    void EnableOperation(IOperation* host) override
    {
...
private:
    ...
    TFuture<void> ValidateOperationPoolsCanBeUsed(const IOperation* operation, const TOperationRuntimeParametersPtr& runtimeParameters)
    {
        if (IdToTree_.empty()) {
