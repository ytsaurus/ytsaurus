    ...
    : public virtual TRefCounted
{
     ...
     */
    virtual TFuture<void> ValidateOperationStart(const IOperation* operation) = 0;
     ...
     *  The implementation must throw no exceptions.
     */
    virtual void DisableOperation(IOperation* operation) = 0;

    //! Must be called for a registered operation after it is materialized.
    virtual void EnableOperation(IOperation* operation) = 0;
    ...
    virtual void ApplyOperationRuntimeParameters(IOperation* operation) = 0;
