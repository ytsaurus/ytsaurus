...
TEST_F(TSchedulingPolicyTest, DontSuggestMoreResourcesThanOperationNeeds)
{
    ...
    EXPECT_CALL(
        ...
        .Times(2)
        .WillRepeatedly(testing::Invoke([&] (auto /*context*/, auto /*allocationLimits*/, auto /*diskResourceLimits*/, auto /*treeId*/, auto /*poolPath*/, auto /*waitingForResourcesOnNodeTimeout*/, auto /*allocationGroupName*/, auto /*allocationId*/) {
