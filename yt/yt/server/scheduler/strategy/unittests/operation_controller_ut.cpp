...
class TOperationControllerTest
    : public testing::Test
{
public:
...
TEST_F(TOperationControllerTest, TestConcurrentScheduleAllocationCallsThrottling)
{
    ...
    EXPECT_CALL(
        ...
        .Times(JobCount)
        .WillRepeatedly(testing::Invoke([&] (auto /*context*/, auto /*jobLimits*/, auto /*diskResourceLimits*/, auto /*treeId*/, auto /*poolPath*/, auto /*waitingForResourcesOnNodeTimeout*/, auto /*allocationGroupName*/, auto /*allocationId*/) {
...
TEST_F(TOperationControllerTest, TestConcurrentScheduleAllocationExecDurationThrottling)
{
    const int JobCount = 10;
    ...
    EXPECT_CALL(
        ...
        ScheduleAllocation(testing::_, testing::_, testing::_, testing::_, testing::_, testing::_, testing::_, testing::_))
        .Times(JobCount + 1)
        .WillOnce(testing::Invoke([&] (auto /*context*/, auto /*jobLimits*/, auto /*diskResourceLimits*/, auto /*treeId*/, auto /*poolPath*/, auto /*waitingForResourcesOnNodeTimeout*/, auto /*allocationGroupName*/, auto /*allocationId*/) {
...
TEST_F(TOperationControllerTest, TestConcurrentControllerScheduleAllocationCallsRegularization)
{
    const int JobCount = 10;
    SchedulerConfig_->MaxConcurrentControllerScheduleAllocationCalls = JobCount;
...
TEST_F(TOperationControllerTest, TestScheduleAllocationTimeout)
{
    auto operation = New<TOperationStrategyHostMock>(TJobResourcesWithQuotaList());
    auto controller = CreateTestOperationController(operation.Get());
