...
std::vector<TClusterComponentInstance> TComponentDiscoverer::ListNodes(EClusterComponentType component) const
{
...
{
    auto execNodeInstances = ListNodes(EClusterComponentType::ExecNode);
