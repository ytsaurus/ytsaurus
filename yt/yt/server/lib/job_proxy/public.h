...
DECLARE_REFCOUNTED_STRUCT(TEnvironmentVariableConfig)
DECLARE_REFCOUNTED_STRUCT(TContainerGpuConfig)
...
DECLARE_REFCOUNTED_STRUCT(TJobApiServiceConfig)
DECLARE_REFCOUNTED_STRUCT(TJobProxyPeakMemoryProfilerConfig)
