...
Y_DECLARE_PODTYPE(NYT::NHydra2::TChangelogHeader_4);
Y_DECLARE_PODTYPE(NYT::NHydra2::TChangelogHeader_5);
Y_DECLARE_PODTYPE(NYT::NHydra2::TChangelogRecordHeader_4);
Y_DECLARE_PODTYPE(NYT::NHydra2::TChangelogRecordHeader_5);
Y_DECLARE_PODTYPE(NYT::NHydra2::TChangelogIndexHeader);
Y_DECLARE_PODTYPE(NYT::NHydra2::TChangelogIndexRecord);
Y_DECLARE_PODTYPE(NYT::NHydra2::TSnapshotHeader);
