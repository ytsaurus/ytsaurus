...
#define DECLARE_INTERFACE_ENTITY_MAP_ACCESSORS_IMPL(entityName, entityNamePlural, entityType) \
    virtual entityType* Find ## entityName(const ::NYT::NHydra2::TEntityKey<entityType>& id) const = 0; \
    virtual entityType* Get ## entityName(const ::NYT::NHydra2::TEntityKey<entityType>& id) const = 0; \
    virtual const ::NYT::NHydra2::TReadOnlyEntityMap<entityType>& entityNamePlural() const = 0;
...
#define DECLARE_ENTITY_MAP_ACCESSORS_IMPL(entityName, entityNamePlural, entityType) \
    entityType* Find ## entityName(const ::NYT::NHydra2::TEntityKey<entityType>& id) const; \
    entityType* Get ## entityName(const ::NYT::NHydra2::TEntityKey<entityType>& id) const; \
    const ::NYT::NHydra2::TReadOnlyEntityMap<entityType>& entityNamePlural() const;

#define DECLARE_ENTITY_MAP_ACCESSORS_OVERRIDE_IMPL(entityName, entityNamePlural, entityType) \
    virtual entityType* Find ## entityName(const ::NYT::NHydra2::TEntityKey<entityType>& id) const override; \
    virtual entityType* Get ## entityName(const ::NYT::NHydra2::TEntityKey<entityType>& id) const override; \
    virtual const ::NYT::NHydra2::TReadOnlyEntityMap<entityType>& entityNamePlural() const override;
...
#define DEFINE_ENTITY_MAP_ACCESSORS_IMPL(declaringType, entityName, entityNamePlural, entityType, map) \
    entityType* declaringType::Find ## entityName(const ::NYT::NHydra2::TEntityKey<entityType>& id) const \
    { \
        return (map).Find(id); \
    } \
    \
    entityType* declaringType::Get ## entityName(const ::NYT::NHydra2::TEntityKey<entityType>& id) const \
    { \
        return (map).Get(id); \
    } \
    \
    const ::NYT::NHydra2::TReadOnlyEntityMap<entityType>& declaringType::entityNamePlural() const \
    { \
        return (map); \
    }
