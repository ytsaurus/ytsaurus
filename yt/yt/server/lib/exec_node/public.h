...
DECLARE_REFCOUNTED_STRUCT(TJobDirectoryManagerDynamicConfig)
DECLARE_REFCOUNTED_STRUCT(TTmpfsLayerCacheDynamicConfig)
DECLARE_REFCOUNTED_STRUCT(TLayerCacheDynamicConfig)
DECLARE_REFCOUNTED_STRUCT(TVolumeManagerDynamicConfig)
DECLARE_REFCOUNTED_STRUCT(TUserJobSensor)
DECLARE_REFCOUNTED_STRUCT(TUserJobStatisticSensor)
