...
private:
    void ListSystemAttributes(std::vector<TAttributeDescriptor>* descriptors) override
    {
        ...
        // COMPAT(kvk1920)
        bool replicateMaintenanceFlags =
            GetCurrentReign() < ToUnderlying(EMasterReign::FixMaintenanceRequestInconsistencyOnMasterCellAddition) &&
            !Bootstrap_->GetDynamicConfig()->NodeTracker->DisableMaintenanceFlagReplication;
