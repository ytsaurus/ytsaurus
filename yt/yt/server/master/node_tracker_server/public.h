...
DECLARE_REFCOUNTED_STRUCT(TDynamicNodeTrackerTestingConfig)
DECLARE_REFCOUNTED_STRUCT(TDynamicNodeTrackerConfig)
DECLARE_REFCOUNTED_STRUCT(TNodeDiscoveryManagerConfig)
