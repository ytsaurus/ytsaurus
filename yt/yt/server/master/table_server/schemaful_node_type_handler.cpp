    ...
    const TLockRequest& lockRequest)
{
    ...
    branchedNode->SetConstraints(originatingNode->GetConstraints());
}
    ...
    TImpl* branchedNode)
{
    ...
    originatingNode->SetConstraints(branchedNode->GetConstraints());
    ...
    NSecurityServer::TAccount* account)
{
    ...
    clonedTrunkNode->SetConstraints(sourceNode->GetConstraints());
}
    ...
    NCypressServer::TSerializeNodeContext* context)
{
    ...
    Save(*context, schemafulNode->GetConstraints());
}
