...
private:
    ...
    const std::unique_ptr<TChunkStatisticsCalculator> ChunkStatisticsCalculator_;
    ...
    const std::unique_ptr<TChunkScanQueue> ChunksAwaitingRequisitionUpdateScheduling_;
