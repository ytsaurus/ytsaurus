...
void TPortalExitNode::FillInheritableAttributes(TTransientAttributes *attributes, ENodeMaterializationReason mode) const
{
    TCompositeNodeBase::FillInheritableAttributes(attributes, mode);
