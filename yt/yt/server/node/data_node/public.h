...
DECLARE_REFCOUNTED_CLASS(TRemoveChunkJobDynamicConfig)
...
DECLARE_REFCOUNTED_CLASS(TOffshoreReplicateChunkJobDynamicConfig)
DECLARE_REFCOUNTED_CLASS(TOffshoreRemoveChunkJobDynamicConfig)
