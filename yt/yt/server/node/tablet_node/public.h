...
DECLARE_REFCOUNTED_STRUCT(IStoreContext)
...
DECLARE_REFCOUNTED_STRUCT(TCompactionHintFetcherConfig)
DECLARE_REFCOUNTED_STRUCT(TTabletHydraManagerConfig)
DECLARE_REFCOUNTED_STRUCT(TTransactionManagerConfig)
DECLARE_REFCOUNTED_STRUCT(TTransactionManagerDynamicConfig)
