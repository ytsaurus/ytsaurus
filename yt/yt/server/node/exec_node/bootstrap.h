    ...
    : public virtual NClusterNode::IBootstrapBase
{
    ...
    virtual NConcurrency::IThroughputThrottlerPtr GetThrottler(EExecNodeThrottlerKind kind, EExecNodeThrottlerTrafficType trafficType = EExecNodeThrottlerTrafficType::Bandwidth, std::optional<NScheduler::TClusterName> remoteClusterName = std::nullopt) const = 0;
