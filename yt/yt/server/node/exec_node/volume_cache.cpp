    ...
    TPrepareSquashFSVolumeOptions options)
{
    ...
    if (cookie.IsActive()) {
        ...
        YT_LOG_DEBUG(
            ...
            value.IsSet() && value.BlockingGet().IsOK() ? ToString(value.Get().Value()->GetId()) : "<importing>");
    }
    ...
    TPrepareLayerOptions options)
{
    ...
    if (cookie.IsActive()) {
        ...
        YT_LOG_DEBUG(
            ...
            value.IsSet() && value.BlockingGet().IsOK() ? ToString(value.Get().Value()->GetMeta().Id) : "<importing>");
    }
