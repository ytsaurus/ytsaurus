...
const TArtifactPtr& TJobFSSecretary::GetArtifactByName(const TString& name) const
{
    return GetOrCrash(NameToPreparedArtifacts_, name);
}

const TArtifactDescription& TJobFSSecretary::GetUserArtifactDescriptor(const TString& name) const
{
