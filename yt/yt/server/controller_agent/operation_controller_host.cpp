...
const IInvokerPtr& TOperationControllerHost::GetChunkScraperHeavyThreadPoolInvoker()
{
    return Bootstrap_->GetControllerAgent()->GetChunkScraperHeavyThreadPoolInvoker();
}
