...
void TDockerRegistryConfig::Register(TRegistrar registrar)
{
    registrar.Parameter("internal_registry_address", &TThis::InternalRegistryAddress)
        .Default();
    registrar.Parameter("internal_registry_addresses", &TThis::InternalRegistryAddresses)
        .Default();
    ...
    registrar.Postprocessor([&] (TDockerRegistryConfig* options) {
        if (!options->InternalRegistryAddress.empty()) {
            options->InternalRegistryAddresses.push_back(options->InternalRegistryAddress);
        }
