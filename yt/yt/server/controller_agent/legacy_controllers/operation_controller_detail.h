...
#include <yt/server/lib/legacy_chunk_pools/input_stream.h>
...
public:
    ...
    virtual void RegisterInputStripe(const NLegacyChunkPools::TChunkStripePtr& stripe, const TTaskPtr& task) override;
    virtual void AddTaskLocalityHint(const NLegacyChunkPools::TChunkStripePtr& stripe, const TTaskPtr& task) override;
    ...
    virtual NScheduler::TExtendedJobResources GetAutoMergeResources(
        const NLegacyChunkPools::TChunkStripeStatisticsVector& statistics) const override;
    ...
    virtual void ReleaseIntermediateStripeList(const NLegacyChunkPools::TChunkStripeListPtr& stripeList) override;
...
protected:
    ...
    struct TStripeDescriptor
    {
        ...
        TStripeDescriptor()
            : Cookie(NLegacyChunkPools::IChunkPoolInput::NullCookie)
        { }
    ...
    virtual NLegacyChunkPools::TOutputOrderPtr GetOutputOrder() const;
    ...
    virtual void RegisterTeleportChunk(
        ...
        NLegacyChunkPools::TChunkStripeKey key,
    ...
    i64 GetFinalIOMemorySize(
        ...
        const NLegacyChunkPools::TChunkStripeStatisticsVector& stripeStatistics) const;
    ...
    NLegacyChunkPools::TInputStreamDirectory GetInputStreamDirectory() const;
    ...
    const NLegacyChunkPools::IChunkPoolInputPtr& GetSink();
...
private:
    ...
    NLegacyChunkPools::IChunkPoolInputPtr Sink_;
    ...
    TReleaseQueue<NLegacyChunkPools::TChunkStripeListPtr> IntermediateStripeListReleaseQueue_;
    TReleaseQueue<NLegacyChunkPools::TChunkStripeListPtr>::TCookie IntermediateStripeListSnapshotCookie_ = 0;
    ...
    public:
        ...
        virtual void Reset(TCookie cookie, NLegacyChunkPools::TChunkStripePtr stripe, NLegacyChunkPools::TInputChunkMappingPtr chunkMapping) override;
    ...
    private:
        DECLARE_DYNAMIC_PHOENIX_TYPE(TSink, 0x7fb74a91);
