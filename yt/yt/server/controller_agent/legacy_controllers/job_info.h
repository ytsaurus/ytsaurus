...
public:
    ...
    NLegacyChunkPools::TChunkStripeListPtr InputStripeList;
    NLegacyChunkPools::IChunkPoolOutput::TCookie OutputCookie;
    ...
    : public TRefCounted
{
    ...
    NLegacyChunkPools::IChunkPoolInput::TCookie InputCookie;
    NLegacyChunkPools::TChunkStripePtr InputStripe;
    bool Restartable;
