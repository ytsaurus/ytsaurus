...
#include <yt/server/lib/legacy_chunk_pools/vanilla_chunk_pool.h>
...
private:
    DECLARE_DYNAMIC_PHOENIX_TYPE(TVanillaTask, 0x55e9aace);
...
private:
    DECLARE_DYNAMIC_PHOENIX_TYPE(TVanillaController, 0x99fa99af);
