    ...
    , public NPhoenix::TFactoryTag<NPhoenix::TNullFactory>
{
    ...
    virtual void RegisterInputStripe(const NLegacyChunkPools::TChunkStripePtr& stripe, const TTaskPtr& task) = 0;
    virtual void AddTaskLocalityHint(const NLegacyChunkPools::TChunkStripePtr& stripe, const TTaskPtr& task) = 0;
    ...
    virtual void ReleaseIntermediateStripeList(const NLegacyChunkPools::TChunkStripeListPtr& stripeList) = 0;
    ...
    virtual void RegisterRecoveryInfo(
        ...
        const NLegacyChunkPools::TChunkStripePtr& stripe) = 0;

    virtual NScheduler::TExtendedJobResources GetAutoMergeResources(
        const NLegacyChunkPools::TChunkStripeStatisticsVector& statistics) const = 0;
