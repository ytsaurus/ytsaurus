...
{
public:
    TCriImageCacheEntry(const TCriImageDescriptor& imageId, const TCriImageDescriptor& imageName, i64 imageSize);
    TCriImageCacheEntry(const TCriImageDescriptor& imageAlias, const TCriImageCacheEntryPtr& entry);
    ~TCriImageCacheEntry();
