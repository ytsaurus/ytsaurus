...
TValueExample::TValueExample(TLogicalTypePtr logicalType, TNamedValue::TValue value, std::string prettyYson)
...
std::vector<TValueExample> GetPrimitiveValueExamples()
{
    static const std::vector<TValueExample> valueExamples = {
        ...
        TValueExample{String(), std::string(TStringBuf("\xf0\x00"sv)), R"("\xf0\x00")"},
        ...
        TValueExample{
            Uuid(),
            std::string(16, 0),
            std::string(TStringBuf(R"("\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00")"))
        },
        TValueExample{
            Uuid(),
            std::string(TStringBuf("\x01\x23\x45\x67\x89\xAB\xCD\xEF\xFE\xDC\xBA\x98\x76\x54\x32\x10"sv)),
            std::string(TStringBuf(R"("\x01\x23\x45\x67\x89\xAB\xCD\xEF\xFE\xDC\xBA\x98\x76\x54\x32\x10")"))
        },
        ...
        TValueExample{
            TzDate(),
            std::string(TStringBuf("\x00\x2a\x45\x75\x72\x6f\x70\x65\x2f\x4d\x6f\x73\x63\x6f\x77"sv)),
            std::string(TStringBuf(R"("\x00\x2a\x45\x75\x72\x6f\x70\x65\x2f\x4d\x6f\x73\x63\x6f\x77")"))
        },

        TValueExample{
            TzDatetime(),
            std::string(TStringBuf("\x00\x00\x00\x2a\x45\x75\x72\x6f\x70\x65\x2f\x4d\x6f\x73\x63\x6f\x77"sv)),
            std::string(TStringBuf(R"("\x00\x00\x00\x2a\x45\x75\x72\x6f\x70\x65\x2f\x4d\x6f\x73\x63\x6f\x77")"))
        },
        TValueExample{
            TzTimestamp(),
            std::string(TStringBuf("\x00\x00\x00\x00\x00\x00\x00\x2a\x45\x75\x72\x6f\x70\x65\x2f\x4d\x6f\x73\x63\x6f\x77"sv)),
            std::string(TStringBuf(R"("\x00\x00\x00\x00\x00\x00\x00\x2a\x45\x75\x72\x6f\x70\x65\x2f\x4d\x6f\x73\x63\x6f\x77")"))
        },
        TValueExample{
            TzDate32(),
            std::string(TStringBuf("\x00\x00\x00\x2a\x45\x75\x72\x6f\x70\x65\x2f\x4d\x6f\x73\x63\x6f\x77"sv)),
