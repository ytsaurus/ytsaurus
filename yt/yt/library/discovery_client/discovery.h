...
//! An interface for keeping and updating a list of participants that are alive
    ...
    : public virtual TRefCounted
{
    ...
    virtual TFuture<void> Enter(const std::string& name, NYTree::IAttributeDictionaryPtr attributes) = 0;
