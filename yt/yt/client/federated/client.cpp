...
static constexpr auto& Logger = FederatedClientLogger;
...
TRANSACTION_METHOD_IMPL(TPushQueueProducerResult, PushQueueProducer, (const NYPath::TRichYPath&, const NYPath::TRichYPath&, const TString&, i64, NTableClient::TNameTablePtr, TSharedRange<NTableClient::TUnversionedRow>, const std::optional<NYson::TYsonString>&, const TPushQueueProducerOptions&));
