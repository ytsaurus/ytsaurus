...
TRANSACTION_METHOD_IMPL(TPushProducerResult, PushProducer, (const NYPath::TRichYPath&, const NYPath::TRichYPath&, const TString&, i64, NTableClient::TNameTablePtr, TSharedRange<NTableClient::TUnversionedRow>, const std::optional<NYson::TYsonString>&, const TPushProducerOptions&));
