...
DECLARE_REFCOUNTED_STRUCT(TLocalDiskRequest)
DECLARE_REFCOUNTED_STRUCT(TNbdDiskRequest)
...
DECLARE_REFCOUNTED_STRUCT(TGangOptions)
...
DECLARE_REFCOUNTED_STRUCT(TStrategyPackingConfig)
DECLARE_REFCOUNTED_STRUCT(TStrategyOperationSpec)
DECLARE_REFCOUNTED_STRUCT(TOperationPoolTreeRuntimeParameters)
DECLARE_REFCOUNTED_STRUCT(TOperationJobShellRuntimeParameters)
DECLARE_REFCOUNTED_STRUCT(TOperationRuntimeParameters)
DECLARE_REFCOUNTED_STRUCT(TOperationPoolTreeRuntimeParametersUpdate)
