...
public:
    ...
    virtual TMutableUnversionedRow GetRow(TChunkedMemoryPool* memoryPool) = 0;
...
public:
    ...
    TMutableUnversionedRow GetRow(TChunkedMemoryPool* memoryPool) override;
...
private:
    ...
    // TODO(achulkov2): Not all of the fields below are actually used in this class,
    // but this copy-paste is acceptable for now, considering that this branch will be
    // removed once we switch to true columnar readers for external formats.
