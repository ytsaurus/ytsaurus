...
// TODO(achulkov2): This class is pretty much copy-paste, but I don't want to spend
// time on generalizing it, considering that this branch will be removed once we switch
// to true columnar readers for external formats.
