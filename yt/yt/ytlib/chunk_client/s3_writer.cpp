...
private:
    ...
    void SchedulePartUpload()
    {
        ...
        auto md5 = MD5::Data(data.ToStringBuf());
        int partIndex = std::ssize(PendingPartUploads_);
        auto partSize = data.Size();

        YT_LOG_DEBUG(
            "Scheduling part upload (PartIndex: %v, ObjectOffset: %v, Size: %v, Md5: %v)",
            partIndex,
    ...
    void DoComplete()
    {
        ...
        for (const auto& [partIndex, partUpload] : Enumerate(pendingPartUploads)) {
            ...
            uploadedParts[partIndex] = NS3::TCompleteMultipartUploadRequest::TPart{
                .PartIndex = static_cast<int>(partIndex),
...
public:
    ...
    TWrittenChunkReplicasInfo GetWrittenChunkReplicasInfo() const override
    {
        ...
        // TODO(achulkov2): What should we return here for S3 replicas?
        YT_UNIMPLEMENTED();
    }
    ...
    bool IsCloseDemanded() const override
    {
        ...
        // TODO(achulkov2): Do we need to do this?
    }
