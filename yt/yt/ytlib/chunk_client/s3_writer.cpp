...
private:
    ...
    // TODO(achulkov2): [PForReview] Add pending queue size to log messages.
    ...
    // TODO(achulkov2): [PForReview] Show that I am guarded.
    ...
    void DoComplete()
    {
        ...
        // TODO(achulkov2): [PNow] Thread-safe access to UploadId_?
        // TODO(achulkov2): [PLater] Cancel this future if the session is aborted.
...
public:
    ...
    TWrittenChunkReplicasInfo GetWrittenChunkReplicasInfo() const override
    {
        ...
        // TODO(achulkov2): [PForReview] Only return replica if write was succesful?
        // This method should only be called after writer is successfully closed, so idk.
    ...
    {
        // TODO(achulkov2): [PForReview] Think a bit more about right value.
        return false;
    }
