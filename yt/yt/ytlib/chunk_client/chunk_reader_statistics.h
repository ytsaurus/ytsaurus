    ...
    : public TRefCounted
{
    ...
    NProfiling::THistogramPtr DataWaitTimeHistogram = CreateRequestTimeHistogram();
    NProfiling::THistogramPtr MetaWaitTimeHistogram = CreateRequestTimeHistogram();

    static NProfiling::THistogramPtr CreateRequestTimeHistogram();
...
private:
    ...
    NProfiling::TEventTimer DataWaitTimeHistogram_;
    NProfiling::TEventTimer MetaWaitTimeHistogram_;
};
