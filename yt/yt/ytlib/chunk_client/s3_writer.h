...
// TODO(achulkov2): [PLater] Add more options: throttlers, traffic meters (?), etc.
IChunkWriterPtr CreateS3Writer(
    TS3MediumDescriptorPtr mediumDescriptor,
    TS3WriterConfigPtr config,
    // TODO(achulkov2): [PForReview] Do we need session id with medium index, or can we just use chunk id?
