    ...
    const TNetworkPreferenceList& networks)
{
    ...
    auto primaryChannel = channelFactory->CreateChannel(
        primaryPeerDescriptor.GetAddressOrThrow(networks),
    ...
    auto backupChannel = channelFactory->CreateChannel(
        backupPeerDescriptor.GetAddressOrThrow(networks),
        backupPeerDescriptor.GetDefaultAddress());
