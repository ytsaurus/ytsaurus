...
public:
    bool Banned;
    THashSet<TString> MemberOfClosure;
...
class TUserAttributeCache
    : public NObjectClient::TObjectAttributeAsYsonStructCacheBase<TString, TUserAttributesPtr>
{
public:
    using TBase = NObjectClient::TObjectAttributeAsYsonStructCacheBase<TString, TUserAttributesPtr>;
    using TBase::TBase;

private:
    NYPath::TYPath GetPath(const TString& key) const override;
};
