...
static const auto SmallSchema2 = New<TTableSchema>(std::vector{
    ...
    TColumnSchema("v1", EValueType::Int64).SetAggregate("max"),
...
static const auto LargeSchema1 = New<TTableSchema>(std::vector{
    ...
    TColumnSchema("v4", EValueType::Double).SetGroup("group2").SetAggregate("max"),
    TColumnSchema("v5", EValueType::Int64).SetGroup("group1"),
    TColumnSchema("v6", EValueType::Double).SetGroup("group3").SetAggregate("max"),
    TColumnSchema("v7", EValueType::Int64),
    TColumnSchema("v8", EValueType::Uint64).SetGroup("group3"),
    TColumnSchema("v9", EValueType::Uint64).SetGroup("group3").SetAggregate("max"),
    TColumnSchema("v10", EValueType::Int64),
    TColumnSchema("v11", EValueType::Double).SetAggregate("max"),
    TColumnSchema("v12", EValueType::Int64).SetGroup("group1"),
    TColumnSchema("v13", EValueType::Int64).SetGroup("group2").SetAggregate("max"),
...
static const auto LargeSchema2 = New<TTableSchema>(std::vector{
    ...
    TColumnSchema("v1", EValueType::String).SetAggregate("max"),
    ...
    TColumnSchema("v11", EValueType::Double).SetAggregate("max"),
    TColumnSchema("v12", EValueType::Int64).SetGroup("group1"),
    TColumnSchema("v13", EValueType::String).SetGroup("group2").SetAggregate("max"),
    TColumnSchema("v14", EValueType::Boolean).SetGroup("group2"),
