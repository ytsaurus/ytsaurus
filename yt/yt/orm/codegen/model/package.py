...
class OrmModule:
    ...
    def _analyze_options(self, options):
        ...
        # Only YP uses protobuf reflection to get list of object types.
        self._is_public = compat.yp() and (bool(self.object_type_options) or bool(self.extend_object_type_options))
...
class OrmPackage:
    ...
    def get_sourced_messages(self, filter=None):
        result = {}
        for message in self.messages:
