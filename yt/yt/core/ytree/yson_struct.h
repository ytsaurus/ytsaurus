 ...
 * To use it you must add `REGISTER_YSON_STRUCT(TYourClass);` line in your class
 * and configure fields in static method TYourClass::Register(TRegistrar registrar).
...
//    static_assert(std::is_base_of_v<TYsonStructLite, TThis> != std::is_base_of_v<TYsonStruct, TThis>);
