...
// COMPAT(babenko)
#define YT_ASSERT_THREAD_AFFINITY(...) VERIFY_THREAD_AFFINITY(__VA_ARGS__)
#define YT_ASSERT_SPINLOCK_AFFINITY(...) VERIFY_SPINLOCK_AFFINITY(__VA_ARGS__)
#define YT_ASSERT_READER_SPINLOCK_AFFINITY(...) VERIFY_READER_SPINLOCK_AFFINITY(__VA_ARGS__)
#define YT_ASSERT_WRITER_SPINLOCK_AFFINITY(...) VERIFY_WRITER_SPINLOCK_AFFINITY(__VA_ARGS__)
#define YT_ASSERT_INVOKER_AFFINITY(...) VERIFY_INVOKER_AFFINITY(__VA_ARGS__)
#define YT_ASSERT_SERIALIZED_INVOKER_AFFINITY(...) VERIFY_SERIALIZED_INVOKER_AFFINITY(__VA_ARGS__)
#define YT_ASSERT_INVOKERS_AFFINITY(...) VERIFY_INVOKERS_AFFINITY(__VA_ARGS__)
#define YT_ASSERT_INVOKER_POOL_AFFINITY(...) VERIFY_INVOKER_POOL_AFFINITY(__VA_ARGS__)
#define YT_ASSERT_INVOKER_THREAD_AFFINITY(...) VERIFY_INVOKER_THREAD_AFFINITY(__VA_ARGS__)
