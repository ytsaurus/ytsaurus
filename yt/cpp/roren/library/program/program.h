...
class TMoveIndicator {
public:
    TMoveIndicator() = default;
    TMoveIndicator(const TMoveIndicator&) = delete;
    TMoveIndicator(TMoveIndicator&& other);

    TMoveIndicator& operator=(const TMoveIndicator&) = delete;
    TMoveIndicator& operator=(TMoveIndicator&& other);
...
class TProgram : public NPrivate::TMoveIndicator
{
public:
    class TExecutorStub;
