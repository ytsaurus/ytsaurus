...
///     can be used here
template <typename T>
TReadApplicator<T> YtRead(NYT::TRichYPath path)
{
    ...
    return TReadApplicator<T>{inner};
}
...
TYtAutoSchemaSortedWriteApplicator YtSortedWrite(const NYT::TRichYPath& path, const NYT::TSortColumns& sortColumns);
