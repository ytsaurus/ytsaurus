...
TBigRtExecutorPoolPtr MakeExecutorPool(const TPipeline& pipeline)
{
    ...
    Y_ABORT_UNLESS(description.WriterRegistratorList.empty(), "Resharder has nontrivial writers and must be created with CompositeWriterFactory");
