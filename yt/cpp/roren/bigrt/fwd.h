...
class TBigRtProgramProtoConfig;
struct TBigRtConfig;
using TBigRtConfigPtr = NYT::TIntrusivePtr<TBigRtConfig>;
struct TBigRtProgramConfig;
using TBigRtProgramConfigPtr = NYT::TIntrusivePtr<TBigRtProgramConfig>;

template <typename T>
class TBigRtProgram;

struct TBigRtEnvironment;
using TBigRtEnvironmentPtr = NYT::TIntrusivePtr<TBigRtEnvironment>;
