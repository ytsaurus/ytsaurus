...
//
// Furthermore data from blob tables can be sky shared. In order to achieve this blob table must satisfy additional constrains.
...
NYT::IFileWriterPtr CreateBlobTableWriter(
    NYT::TTableWriterPtr<NYT::TNode> writer,
    NYT::TNode node,
    const TBlobTableSchema& schema,
    int firstPartIndex = 0,
    bool autoFinishOfWriter = true);

////////////////////////////////////////////////////////////////////////////////

NYT::TTableSchema CreateSortedBlobTableSchema(const NYT::TTableSchema& tableSchema, const TBlobTableSchema& blobTableSchema);
