...
NTi::TTypePtr GetYTType(const std::shared_ptr<arrow20::DataType>& arrowType)
{
    switch (arrowType->id()) {
        ...
        case arrow20::Type::type::LIST:
            return NTi::List(
                GetYTType(std::reinterpret_pointer_cast<arrow20::ListType>(arrowType)->value_type()));

        case arrow20::Type::type::MAP:
            return NTi::Dict(
                GetYTType(std::reinterpret_pointer_cast<arrow20::MapType>(arrowType)->key_type()),
                GetYTType(std::reinterpret_pointer_cast<arrow20::MapType>(arrowType)->item_type()));
