...
$ cat ya.make:
    ...
    TEST_SRCS(
        yt/cpp/mapreduce/tests/run_yt_unittests.py # path to current script
    )
    PEERDIR(
    ...
    DEPENDS(
        ...
        yt/cpp/mapreduce/tests/native_new # path to unittest directory
    )
    END()
$ cat yt_unittest_conf.py
    BINARY_PATH = "yt/cpp/mapreduce/tests/native_new/test-native-interface" # path to unittest binary
"""
