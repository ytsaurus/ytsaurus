...
Y_UNIT_TEST_SUITE(Operations)
{
    ...
    Y_UNIT_TEST(TestSkiffAllTypes)
    {
...

        {
            ...
            UNIT_ASSERT_VALUES_EQUAL(spec["mapper"]["input_format"].AsString(), "skiff");
        }
    ...
    Y_UNIT_TEST(MiscOptions)
    {
        ...
        UNIT_ASSERT_VALUES_EQUAL(spec["resource_limits"]["user_slots"].AsInt64(), 42);
        UNIT_ASSERT_VALUES_EQUAL(spec["resource_limits"]["cpu"].AsInt64(), 54);
        UNIT_ASSERT_VALUES_EQUAL(spec["resource_limits"]["memory"].AsInt64(), 500_MB);
        UNIT_ASSERT_VALUES_EQUAL(spec["resource_limits"]["memory"].AsInt64(), 500_MB);
        UNIT_ASSERT_VALUES_EQUAL(spec["pool_trees"], TNode::CreateList().Add("default"));
        UNIT_ASSERT_VALUES_EQUAL(spec["weight"].AsDouble(), 2.0);
    }
