...
// Handler will print on stderr possibly helpfull backtrace and
...
//
// As long as there is TErrorContext object registered, signal handler will
// output content of the buffer filled by ToString call to the stderr
