...
// TRow AllocateRow(TRowBuffer* memoryPools, int rowSize) does not work
    ...
    const TOperator* op)
{
    ...
    TCGContext ctx(context, module, executionEngine, params, constants, pools, passedFragmentParamsPtr);
