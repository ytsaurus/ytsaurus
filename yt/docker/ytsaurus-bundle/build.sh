...
docker build -t ${image_cr}ytsaurus/ytsaurus-bundle:${ytsaurus_tag} . --build-arg YTSAURUS_TAG=${ytsaurus_tag} --build-arg QUERY_TRACKER_TAG=${query_tracker_tag} --build-arg STRAWBERRY_TAG=${strawberry_tag} --build-arg IMAGE_CR=${image_prefix}
