...
docker create --name ytsaurus-puthon-packages localhost/ytsaurus-python-packages:latest true
docker export ytsaurus-puthon-packages | tar -xv --wildcards '*.whl'
docker rm ytsaurus-puthon-packages
```
