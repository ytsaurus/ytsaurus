...
TEST(TAutoMergeTest, SimpleScenario)
{
    ...
    EXPECT_FALSE(director.CanSchedulerMergeJob(4));
    ...
    EXPECT_TRUE(director.CanSchedulerMergeJob(17));
    director.OnMergeJobStarted();
    EXPECT_TRUE(director.CanSchedulerMergeJob(12));
    director.OnMergeJobStarted();
    EXPECT_TRUE(director.CanSchedulerMergeJob(7));
    director.OnMergeJobStarted();
    // 2 chunks is too small for our settings.
    EXPECT_FALSE(director.CanSchedulerMergeJob(2));
    ...
    EXPECT_TRUE(director.CanSchedulerMergeJob(4));
    director.OnMergeJobStarted();
...
TEST(TAutoMergeTest, JobFailure)
{
    ...
    EXPECT_FALSE(director.CanSchedulerMergeJob(0));
    ...
    EXPECT_TRUE(director.CanSchedulerMergeJob(10));
    director.OnMergeJobStarted();
