...
TEST(TAutoMergeTest, SimpleScenario)
{
    ...
    EXPECT_TRUE(director.TryScheduleTaskJob(5));
    ...
    EXPECT_TRUE(director.TryScheduleMergeJob(17));
    director.OnMergeJobStarted();
    EXPECT_TRUE(director.TryScheduleMergeJob(12));
    director.OnMergeJobStarted();
    EXPECT_TRUE(director.TryScheduleMergeJob(7));
    director.OnMergeJobStarted();
    // 2 chunks is too small for our settings.
    EXPECT_FALSE(director.TryScheduleMergeJob(2));
    ...
    // mode).
    EXPECT_FALSE(director.TryScheduleTaskJob(4));
    ...
    EXPECT_TRUE(director.TryScheduleTaskJob(4));
...
TEST(TAutoMergeTest, ForceFlush)
{
    ...
    EXPECT_FALSE(director.TryScheduleTaskJob(12));
...
TEST(TAutoMergeTest, BypassMarginalJobs)
{
    ...
    EXPECT_TRUE(director.TryScheduleTaskJob(42));
    director.OnTaskJobStarted(12);
...
TEST(TAutoMergeTest, JobFailure)
{
    ...
    EXPECT_TRUE(director.TryScheduleTaskJob(10));
    ...
    EXPECT_FALSE(director.TryScheduleMergeJob(0));
    ...
    EXPECT_TRUE(director.TryScheduleMergeJob(10));
    director.OnMergeJobStarted();
