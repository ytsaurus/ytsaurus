...
{
    virtual void RefObject(NObjectServer::IObjectBase* object) = 0;
    virtual void UnrefObject(NObjectServer::IObjectBase* object) = 0;
    virtual int GetObjectRefCounter(NObjectServer::IObjectBase* object) = 0;
