...
public:
    TVanillaController(
        ...
        : TOperationControllerBase(spec, controllerAgent->GetConfig()->VanillaOperationOptions, controllerAgent, operation)
        , Spec_(spec)
        , Options_(Config->VanillaOperationOptions)
    { }
    ...
    TOperation* operation)
{
    ...
    return New<TVanillaController>(spec, controllerAgent, operation);
}
