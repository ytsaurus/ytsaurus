...
#include <ytlib/chunk_client/old_multi_chunk_sequential_writer.h>
...
typedef TOldMultiChunkSequentialReader<TTableChunkReader> TReader;
typedef TOldMultiChunkSequentialWriter<TPartitionChunkWriter> TWriter;
