    ...
    def _wait_for_cells_good_after_peer_decommission(self, cell_id):
        def check():
            ...
            for peer in peers:
                ...
                try:
                    actual_config_version = get("//sys/cluster_nodes/{0}/orchid/tablet_cells/{1}/config_version", address, cell_id)
                except:
                    return False

                expected_config_version = get("//sys/tablet_cells/{0}/@config_version", cell_id)
