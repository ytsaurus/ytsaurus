...
from .cache_and_filtration import (
    build_bundle_lookup_rowset,
    build_bundle_key_filter_cache_and_filtration_rowsets,
    build_bundle_lookup_cache_rowsets,
)
...
def build_bundle_ui_cache_and_filtration():
    rowsets = [
        build_bundle_lookup_rowset(),
        *build_bundle_key_filter_cache_and_filtration_rowsets(),
        *build_bundle_lookup_cache_rowsets(),
    ...
    d = (build_bundle_dashboard(rowsets)
        .aggr("user", "table_path", "table_tag", MonitoringTag("host")))
    d.set_title("Bundle UI Cache and filtration [Autogenerated]")
    return d
