...
from yt.admin.ytsaurus_ci import registry_clients
...
def ProcessScenario(
    ...
    clients = registry_clients.build_clients(auths)
    ...
    if scenario.type == "upgrade":
        return _make_upgrade_tasks(scenario, clients, scenario_name, test_registry, upgrade_config)

    return _make_tasks(scenario, clients, scenario_name, test_registry, version_filter)
