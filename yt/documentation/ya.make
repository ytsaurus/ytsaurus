...
DOCS_INCLUDE_SOURCES(
    yt/python/examples/simple_map/__main__.py
    yt/python/examples/simple_reduce/__main__.py
    yt/python/examples/multiple_input_reduce/__main__.py
    yt/python/examples/multiple_input_multiple_output_reduce/__main__.py
    yt/python/examples/table_read_write/__main__.py
    yt/python/examples/map_reduce/__main__.py
    yt/python/examples/batch_client/__main__.py
    yt/python/examples/dynamic_tables_rpc/__main__.py
    yt/python/examples/simple_rpc/__main__.py
    yt/python/examples/table_switches/__main__.py
    yt/python/examples/gevent/__main__.py
    yt/python/examples/yson_string_proxy/__main__.py
    yt/python/examples/files/__main__.py
    yt/python/examples/job_decorators/__main__.py
    yt/python/examples/cpp_simple_map_tnode/mapper.cpp
    yt/python/examples/cpp_simple_map_tnode/__main__.py
    yt/python/examples/cpp_simple_map_protobuf/mapper.cpp
    yt/python/examples/cpp_simple_map_protobuf/__main__.py
    yt/python/examples/cpp_stateful_map/mapper.cpp
    yt/python/examples/cpp_stateful_map/__main__.py
    yt/python/examples/dataclass_types/__main__.py
    yt/python/examples/files_types/__main__.py
    yt/python/examples/grep_typed/__main__.py
    yt/python/examples/job_decorators_typed/__main__.py
    yt/python/examples/map_reduce_typed/__main__.py
    yt/python/examples/map_reduce_multiple_intermediate_streams_typed/__main__.py
    yt/python/examples/multiple_input_multiple_output_reduce_typed/__main__.py
    yt/python/examples/multiple_input_reduce_typed/__main__.py
    yt/python/examples/prepare_operation_typed/__main__.py
    yt/python/examples/simple_map_typed/__main__.py
    yt/python/examples/simple_reduce_typed/__main__.py
    yt/python/examples/spec_builder_typed/__main__.py
    yt/python/examples/table_read_write_typed/__main__.py
    yt/python/examples/table_schema_typed/__main__.py
    yt/python/examples/table_switches_typed/__main__.py
