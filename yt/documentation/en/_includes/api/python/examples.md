...
The example is located at [yt/cpp/mapreduce/examples/typed-python-tutorial/job_decorators](https://github.com/ytsaurus/ytsaurus/tree/main/yt/cpp/mapreduce/examples/typed-python-tutorial/job_decorators).
