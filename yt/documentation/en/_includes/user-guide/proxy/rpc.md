...
This section contains examples of working with YT via RPC proxy for different programming languages: [C++](#c_plus_plus), [Java](#java), and [Python](#python).
...
The source code of the presented examples can be found on [GitHub](https://github.com/ytsaurus/ytsaurus/tree/main/yt/java/ytsaurus-client/src/test/java/tech/ytsaurus/client).
