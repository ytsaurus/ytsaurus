...
# для создания тестовой базы данных используется отдельная функция,
# основанная на функции create_database
def create_test_database(yt_stuff):
    ...
    # таблицы будут создаваться в директории home
    path = "//home"
...
# Эта функция будет запущена один раз за сеанс тестирования: в ней создаются таблицы, и запускается приложение
