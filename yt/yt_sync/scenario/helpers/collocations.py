...
class CollocationState:
    ...
    def add_tables_to_existing_collocation(self, log_only: bool, batch_client: YtClientProxy):
        if not self.actual_collocations:
            return
    ...
    def remove_tables_from_existing_collocation(self, log_only: bool, batch_client: YtClientProxy):
    ...
    def create_collocation(self, log_only: bool, yt_client: YtClientProxy):
...
def ensure_collocation(
    ...
    if state.collocation_exists:
        ...
        state.add_tables_to_existing_collocation(log_only, batch_client)
        state.remove_tables_from_existing_collocation(log_only, batch_client)
    elif state.is_collocation_required:
        state.create_collocation(log_only, yt_client)
