...
from yt.yt_sync.core.model.helpers import get_lca
...
def test_lca():
    assert get_lca("//a/b", "//a/b") == "//a/b"
    assert get_lca("//a/b/c/d", "//a/b") == "//a/b"
    assert get_lca("//a/b", "//a/b/c/d") == "//a/b"
    assert get_lca("//a/b/c1/d", "//a/b/c2/d") == "//a/b"
    assert get_lca("//a/b/c/d1", "//a/b/c/d2") == "//a/b/c"
    assert get_lca("//a/f", "//a/folder") == "//a"
    assert get_lca("//a", "//b") == "/"
