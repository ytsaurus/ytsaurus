...
class TestYtCluster:
    ...
    def test_add_table_from_attributes(self, table_path: str, yt_cluster: YtCluster, table_attrs: Types.Attributes):
    ...
    def test_fix_folders(self, table_path: str, yt_cluster: YtCluster, table_attrs: Types.Attributes):
        ...
        yt_cluster.fix_folders()
        assert table.folder in yt_cluster.nodes
        assert yt_cluster.nodes[table.folder].node_type == YtNode.Type.FOLDER
        assert yt_cluster.nodes[table.folder].is_implicit
        assert node1.folder in yt_cluster.nodes
        assert yt_cluster.nodes[node1.folder].node_type == YtNode.Type.FOLDER
        assert yt_cluster.nodes[node1.folder].is_implicit
        assert node2.folder in yt_cluster.nodes
        assert yt_cluster.nodes[node2.folder].node_type == YtNode.Type.FOLDER
        assert yt_cluster.nodes[node2.folder].is_implicit
