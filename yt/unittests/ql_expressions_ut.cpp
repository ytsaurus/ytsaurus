...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        std::vector<const char*>{
            ...
            "3"},
        std::vector<const char*>{
            "[{name=k;type=int64;sort_order=ascending;expression=l}; {name=l;type=int64;}; {name=m;type=int64}; {name=a;type=int64}]",
            "[k;l]",
            "l in ((0),(2),(4))",
            "l in ((2))",
            "2;2;2",
            "3;3;3"},
        std::vector<const char*>{
            "[{name=k;type=int64}; {name=l;type=int64;sort_order=ascending;expression=k}; {name=a;type=int64}]",
            "[k;l]",
            "k in ((0),(2),(4))",
            "k in ((2))",
            "2;1",
        ...
        std::vector<const char*>{
            ...
            "3"},
        std::vector<const char*>{
            "[{name=k;type=int64}; {name=l;type=int64;sort_order=ascending;expression=k}; {name=m;type=int64}; {name=a;type=int64}]",
            "[k;l]",
            "k in ((0),(2),(4))",
            "k in ((2))",
            "2;2;2",
