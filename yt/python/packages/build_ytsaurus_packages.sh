...
Usage: $script_name [-h|--help]
                    ...
                    [--ytsaurus-package-name some-ytsaurus-package-name (default: all packages will be build) (values: ytsaurus-client, ytsaurus-yson, ytsaurus-local, ytsaurus-native-driver, ytsaurus-admin)]
...
if [[ ${ytsaurus_package_name} == "" ]]; then
    packages=("ytsaurus-client" "ytsaurus-yson" "ytsaurus-local" "ytsaurus-native-driver" "ytsaurus-admin")
    prepare_bindings_libraries=true
 else
