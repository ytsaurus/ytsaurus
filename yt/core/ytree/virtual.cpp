...
TCompositeMapService* TCompositeMapService::AddChild(const Stroka& key, IYPathServicePtr service)
{
    Impl_->AddChild(key, std::move(service));
    return this;
}

TCompositeMapService* TCompositeMapService::AddAttribute(const Stroka& key, TYsonCallback producer)
{
