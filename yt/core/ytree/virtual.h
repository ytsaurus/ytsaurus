...
public:
    ...
    TCompositeMapService* AddChild(const Stroka& key, IYPathServicePtr service);
    TCompositeMapService* AddAttribute(const Stroka& key, NYson::TYsonCallback producer);
