...
$non_unique = (select  channel, item, return_ratio, return_rank, currency_rank from
 ...
 from (
 	...
 	(	select ws.ws_item_sk as item
 		...
 		from
 		 web_sales ws cross join date_dim left join web_returns wr
 ...
 from (
 	...
 	(	select
 		...
 		from
 		catalog_sales cs cross join date_dim left outer join catalog_returns cr
 ...
 from (
 	...
 	(	select sts.ss_item_sk as item
 		...
 		from
 		store_sales sts cross join date_dim left outer join store_returns sr
