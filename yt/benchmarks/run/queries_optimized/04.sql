...
$year_total = (select c.c_customer_id as customer_id
 ...
 where ss.ss_sold_date_sk = d.d_date_sk and c.c_customer_sk = ss.ss_customer_sk
 ...
 cross join customer as c
 where cs.cs_sold_date_sk = d.d_date_sk and c.c_customer_sk = cs.cs_bill_customer_sk
 group by c.c_customer_id
         ,c.c_first_name
         ,c.c_last_name
         ,c.c_preferred_cust_flag
