...
**Default value**: `{}`
Settings for all `timer` streams. Keys must not contain `/` or `:`. ||
...
**Default value**: `{}`
Settings for all `key_visitor` streams. Keys must not contain `/` or `:`. ||
...
**Default value**: `{}`
Settings for all sinks. Keys must not contain `/` or `:`. ||
