# {{product-name}} Flow Extensions

An extension is an optional integration between a pipeline and an external system. Extensions can provide sources, sinks, or other pipeline capabilities.
