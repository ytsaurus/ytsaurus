...
**{{product-name}}** (IPA: [waɪtiːsɔːrəs], pronounced _wai-tee-saw-ruhs_) is a distributed storage and processing platform for large amounts of data. It includes [MapReduce](http://en.wikipedia.org/wiki/MapReduce) computation model, a distributed file system and a NoSQL key-value storage.
