...
The connector works with [sorted dynamic tables](../../../user-guide/dynamic-tables/sorted-dynamic-tables.md) of {{product-name}}. You can perform streaming writes to sorted dynamic tables of {{product-name}}, as well as execute Lookup operations.
...
- Advanced [table resharding](../../../user-guide/dynamic-tables/resharding.md);
- Sync/async lookup operations;
