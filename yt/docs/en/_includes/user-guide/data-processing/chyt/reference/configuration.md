...
The clique speclet is stored in Cypress at `//sys/strawberry/chyt/<alias>/speclet`. You can also view its contents in the [web interface](../../../../../user-guide/data-processing/chyt/cliques/ui.md) on the **Speclet** tab or retrieve it by running the CLI command `yt clickhouse ctl get-speclet`.

A speclet is a set of [options](../../../../../user-guide/data-processing/chyt/cliques/configs.md#options) that are interpreted by the controller at clique startup. In particular, the controller generates the final configuration of CHYT instances based on these options.
...
2. [Options](../../../../../user-guide/data-processing/chyt/cliques/configs.md#options) described in the speclet.
