...
| `user_job/cpu_reserve_millicores` | Amount of CPU guaranteed for a user job at the time of launch. In millicores. |
| `user_job/vcpu_reserve_millicores` | Amount of virtual CPU guaranteed for a user job at the time of launch. In millicores. |
| `user_job/gpu_reserve` | Amount of GPU devices guaranteed for a user job at the time of launch. Pieces. |
