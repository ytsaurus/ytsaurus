...
Flow supports four languages for implementing business logic:
...
- **[YQL](../../flow/yql/getting-started.md)** — declarative pipeline description as an SQL query. It has a low entry barrier and doesn’t require writing code in C++, Java, Kotlin, or Python. It’s under active development, and not all planned features are available yet.