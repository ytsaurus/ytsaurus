...
В файле конфигурации можно указывать несколько профилей для работы с YT. Профиль - это набор настроек с общим именем. Профили могут быть полезны:
...
* `profiles`: словарь, где ключ -- имя профиля, а значение -- конфигурация профиля в стандратном [формате](../../../api/python/userdoc.md#configuration).
