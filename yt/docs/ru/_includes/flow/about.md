...
- Возможность реализации бизнес-логики на [C++](../../flow/cpp/getting-started.md), [Java и Kotlin](../../flow/java/getting-started.md), [Python](../../flow/python/getting-started.md), [Go](../../flow/go/getting-started.md) и [YQL](../../flow/yql/getting-started.md).
