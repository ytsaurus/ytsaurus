...
Clock Server предоставляет общекластерные монотонные метки времени, необходимые для мульти-сельных кластеров {{product-name}}. Обеспечивает согласованный порядок событий на нескольких мастерных селлах.
