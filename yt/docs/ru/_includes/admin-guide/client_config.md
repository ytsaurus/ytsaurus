...
Некоторые настройки YT SDK специфичны конфигурации кластера. Для упрощения работы sdk получают их с кластера из предопределенного места в Кипарисе - `//sys/client_config/default`.
