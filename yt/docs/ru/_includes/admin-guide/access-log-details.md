...
Для команд, управляющих транзакциями, все поля, содержащие пути, пусты. Информация о целевой транзакции представлена, как и в других случаях, в поле `transaction_info`.
