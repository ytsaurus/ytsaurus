...
Описанные ниже действия приведут к потере данных на обновляемых томах, так как тома будут пересозданы заново. Не применяйте эту процедуру к stateful-компонентам, таким как мастеры и data-ноды: их тома хранят данные кластера, которые предварительно нужно перенести. Иначе данные будут безвозвратно потеряны.
