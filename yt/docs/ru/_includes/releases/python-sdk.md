...
#### Новые возможности
  ...
  * Поддержка формата таблиц [blob](https://ytsaurus.tech/docs/ru/user-guide/storage/formats#BLOB)
...
#### Исправления
  * YSON: корректное экранирование некорректных последовательностей, как в реализации bindings.
