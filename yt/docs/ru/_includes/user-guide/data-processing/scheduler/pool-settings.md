...
<!--- NB(eshcherbin): Данный абзац временно убрали, так как обращения к орхидее могут приводить к проблемам.
...
Данная информация доступна в UI на странице Scheduling и на странице операции. Например, там отображаются следующие характеристики:
