...
## Порядок действий для диагностики проблем с производительностью { #steps }

### Шаг 1: Быстрый анализ (Первичная диагностика) { #step1 }
...
### Шаг 2: Принцип "Разделяй и властвуй" { #step2 }
...
### Шаг 3: Уменьшение объема данных на ранних этапах { #step3 }
...
### Шаг 4: Анализ плана выполнения { #step4 }
