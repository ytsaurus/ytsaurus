...
|| 2.11.x | 3.3.0 - 4.2.x | 17, 21, 25 | 2.12, 2.13 | 3.11, 3.12, 3.13 ||
|#

{% note info %}

Java 21 поддерживается начиная со Spark 4.0.x, Java 25 — начиная со Spark 4.2.x. Со Spark 3.x используйте Java 17.
