...
1. Тестирование. Можно создать отдельную клику с новой версией CHYT, чтобы проверить функциональность без риска для рабочих процессов или сравнить результаты со старой версией и не затронуть при этом работу сервиса.
