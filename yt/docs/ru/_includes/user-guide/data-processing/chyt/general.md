...
Клику администрируют *пользователи*, а не администраторы {{product-name}}. В частности, любой пользователь {{product-name}} может в любой момент запустить свою собственную клику (или даже несколько клик). Подробнее см. в разделе [Создание, запуск и остановка клики](../../../../user-guide/data-processing/chyt/how-to-guides/create-start.md).
