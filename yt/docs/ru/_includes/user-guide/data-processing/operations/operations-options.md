...
- `resource_limits`, `max_share_ratio` — настройки fair_share, которые будут действовать суммарно на все джобы операции. Подробнее можно прочитать в разделе [Характеристики пулов](../../../../user-guide/data-processing/scheduler/pool-settings.md#operations));
...
Детальное описание механизма на отдельной [странице](../../../../user-guide/data-processing/scheduler/memory-digest).
