...
|`user_job/cpu_reserve_millicores` | Количество процессорного времени, гарантированное пользовательскому джобу в момент запуска. В миллиядрах. |
|`user_job/vcpu_reserve_millicores` | Количество виртуального процессорного времени, гарантированного пользовательскому джобу в момент запуска. В миллиядрах. |
|`user_job/gpu_reserve` | Количество GPU, гарантированное пользовательскому джобу в момент запуска. В штуках. |
