...
|`job/cpu/cumulative_reserve` | Объем CPU, зарезервированный для выполнения джоба, умноженный на время в миллисекундах. Значение в ядро-миллисекундах. |
|`job/vcpu/cumulative_reserve` | Объем vCPU, зарезервированный для выполнения джоба, умноженный на время в миллисекундах. Значение в ядро-миллисекундах. |
|`job/memory/cumulative_reserve` | Объем памяти (в гибибайтах), зарезервированный для выполнения джоба, умноженный на время в миллисекундах. Значение в гибибайт-миллисекундах. |
|`job/gpu/cumulative_reserve` | Объем GPU, зарезервированный для выполнения джоба, умноженный на время в миллисекундах. Значение в GPU-миллисекундах. |
