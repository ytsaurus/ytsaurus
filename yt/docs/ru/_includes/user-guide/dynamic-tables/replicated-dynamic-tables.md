...
| sync_replica_lag_threshold | Duration | Максимальное значение лага, до которого реплика считается доступной. По умолчанию равен 10 минутам. Такое значение иногда может приводить к долгой дорепликации, в этом случае его рекомендуется уменьшить. |
