...
- На каждом кластере должна быть реплика специального вида - очередь репликации. При недоступности части реплик, в очередях накапливаются логи изменений таблицы, из которых будет восстановлено состояние недоступных реплик после того, как реплики станут доступными. Необходимо учитывать рост очередей во время недоступности реплик при планировании ресурсов кластеров.
