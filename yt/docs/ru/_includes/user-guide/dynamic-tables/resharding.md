...
Непустую сортированную реплицированную таблицу решардировать можно, но только в режиме разбиения таблетов: все граничные ключи старых таблетов должны также присутствовать среди новых граничных ключей.

Непустую упорядоченную реплицированную таблицу решардировать невозможно. При необходимости это сделать нужно пересоздать таблицу с нужными граничными ключами.
