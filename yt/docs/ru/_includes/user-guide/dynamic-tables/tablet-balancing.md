...
Чтобы отключить определённый вид балансировки, следует выставить значение `%false` для соответствующего атрибута (см. таблицу ниже). Это значение необходимо указывать в конфиге:
