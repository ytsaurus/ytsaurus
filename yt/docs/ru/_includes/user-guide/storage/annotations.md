...
Аннотации хранятся в памяти мастер-серверов {{product-name}} и потому достаточно дороги. Рекомендуется ограничивать содержимое аннотаций одним-двумя предложениями и ссылками на более подробную документацию.
...
Аннотации отображаются в разделе **Navigation**, на вкладке **Description** выбранного узла. Чтобы отредактировать аннотацию, нажмите **Edit metadata** и перейдите на вкладку **Description**.
