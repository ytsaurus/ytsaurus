...
В конфиге `table_reader` можно указать настройки семплирования `sampling_seed` и `sampling_rate`:
...
Чтобы получить максимальную скорость чтения с семплированием в операции, пожертвовав качеством семплирования, используйте опцию [`sampling`](../../../user-guide/data-processing/operations/operations-options.md#common_options) в спецификации операции.
