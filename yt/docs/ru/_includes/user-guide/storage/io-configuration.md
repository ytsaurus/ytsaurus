...
### Удалённое чтение и квотирование межкластерной сетевой полосы { #remote_read }

При чтении входных таблиц с других кластеров (удалённое чтение) скорость чтения ограничивается квотами межкластерной сетевой полосы. Подробнее см. в разделе [Квотирование межкластерной сетевой полосы](../../../user-guide/data-processing/operations/cluster-throttlers.md).
