...
Как следует из написанного выше, наследование атрибутов работает только при создании новых узлов. Установка наследуемого атрибута на директорию никак не влияет на уже существующие в этом поддереве узлы. Для того чтобы применить изменение рекурсивно, нужно явно установить атрибут на каждый узел (нужного типа) в поддереве.
