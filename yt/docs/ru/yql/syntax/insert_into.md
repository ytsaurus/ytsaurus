...
Использование конструкции `INSERT INTO` возможно только с модификатором `WITH TRUNCATE`, то есть с семантикой полной перезаписи данных в таблице. Семантика вставки без очистки поддерживается через конструкцию [REPLACE INTO](replace_into.md)
