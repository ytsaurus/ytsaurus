...
Декларативное описание результата задачи в стиле SQL не всегда удобно. Иногда необходимо декларативно задать, какие данные нужно объединить (`JOIN`) и как их сгруппировать, а логику обработки фрагментов данных описать в императивном стиле. Для таких случаев в YQL есть возможность писать и вызывать пользовательские функции User Defined Functions (UDF) на Python.
Подробнее про UDF читайте в разделе [Python User Defined Functions (UDFs) в YQL](../../user-guide/query-tracker/system-python-udf.md).
