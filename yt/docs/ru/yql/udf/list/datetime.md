...
Функция `DateTime::ToSeconds` до версии `2025.03` не поддерживает работу с интервалами с длительностью большей, чем 68 лет. В этом случае можно использовать выражение `DateTime::ToMilliseconds(x) / 1000`.
