...
public class MapperSpecTest {
    ...
    public void testBasic() {
        ...
        Assert.assertTrue(
                node.get("command").stringValue().contains("ru.yandex.yt.ytclient.operations.MapMain 1 simple "
                        .concat("ru.yandex.yt.ytclient.operations.MapperSpecTestdollar_charDummyMapper")));
