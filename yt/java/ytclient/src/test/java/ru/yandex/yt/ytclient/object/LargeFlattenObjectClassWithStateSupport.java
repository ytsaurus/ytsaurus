...
@YTreeObject
public class LargeFlattenObjectClassWithStateSupport extends AbstractYTreeStateSupport<LargeFlattenObjectClassWithStateSupport> {
    @YTreeKeyField
    ...
    @YTreeFlattenField
    private InternalFlattenObject2 object2;
    ...
    public InternalFlattenObject2 getObject2() {
        return object2;
    }

    public void setObject2(InternalFlattenObject2 object2) {
    ...
    public boolean equals(Object o) {
        ...
        LargeFlattenObjectClassWithStateSupport that = (LargeFlattenObjectClassWithStateSupport) o;
    ...
    public String toString() {
        return "LargeFlattenObjectClassWithStateSupport{" +
                "intField1=" + intField1 +
                ", intField2=" + intField2 +
                ", intField3=" + intField3 +
                ", intField4=" + intField4 +
