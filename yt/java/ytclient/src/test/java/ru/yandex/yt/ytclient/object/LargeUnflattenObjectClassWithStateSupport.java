...
@YTreeObject
public class LargeUnflattenObjectClassWithStateSupport extends AbstractYTreeStateSupport<LargeUnflattenObjectClassWithStateSupport> {
    @YTreeKeyField
    ...
    public boolean equals(Object o) {
        ...
        LargeUnflattenObjectClassWithStateSupport that = (LargeUnflattenObjectClassWithStateSupport) o;
    ...
    public String toString() {
        return "LargeUnflattenObjectClassWithStateSupport{" +
                "intField1=" + intField1 +
                ", intField2=" + intField2 +
                ", intField3=" + intField3 +
                ", intField4=" + intField4 +
