...
@YTreeObject
public class LargeObjectWithListClass {
    @YTreeKeyField
    ...
    private List<Integer> listField1;
    ...
    public List<Integer> getListField1() {
        return listField1;
    }

    public void setListField1(List<Integer> listField1) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LargeObjectWithListClass)) {
            return false;
        }
        LargeObjectWithListClass that = (LargeObjectWithListClass) o;
        return Objects.equals(intField1, that.intField1) &&
                ...
                Objects.equals(listField1, that.listField1);
    }

    @Override
    public int hashCode() {
        return Objects.hash(intField1, intField2, intField3, intField4, intField5, longField1, longField2, longField3
                , longField4, longField5, floatField1, floatField2, floatField3, floatField4, floatField5,
                doubleField1, doubleField2, doubleField3, doubleField4, doubleField5, booleanField1, booleanField2,
                booleanField3, booleanField4, booleanField5, stringField1, stringField2, stringField3, stringField4,
                stringField5, listField1);
    }

    @Override
    public String toString() {
        return "LargeObjectWithListClass{" +
                "intField1=" + intField1 +
                ", intField2=" + intField2 +
                ", intField3=" + intField3 +
                ", intField4=" + intField4 +
