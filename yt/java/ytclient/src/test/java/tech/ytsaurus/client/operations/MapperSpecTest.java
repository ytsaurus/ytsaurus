...
public class MapperSpecTest {
    ...
    public void testBasic() {
        ...
        Assert.assertTrue(
                node.get("command").stringValue().contains("tech.ytsaurus.client.operations.MapMain 1 simple "
                        .concat("tech.ytsaurus.client.operations.MapperSpecTestdollar_charDummyMapper")));
    ...
    private static class DummyMapper implements Mapper<YTreeMapNode, YTreeMapNode> {
        @Override
        public void map(YTreeMapNode entries, Yield<YTreeMapNode> yield, Statistics statistics,
