...
public class LinkNode
    ...
    public static class Builder extends BuilderBase<Builder, LinkNode> {
        @Override
    ...
    public abstract static class BuilderBase<
            ...
            extends CopyLikeReq.Builder<TBuilder, TRequest> implements HighLevelRequest<TReqLinkNode.Builder> {
