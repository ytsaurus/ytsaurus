...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            artifactId = "flow-spring-boot-starter"
            ...
            pom {
                name.set("YTsaurus Flow Java SDK Spring Boot starter")
                description.set("Spring Boot autoconfiguration for the YTsaurus Flow Java SDK")
