 ...
 * <p>
 * {@link tech.ytsaurus.flow.row.FlowMessage} POJOs are not beans, so they are not a trigger here; a
 * pipeline declaring them always also declares a computation, which activates the autoconfiguration.
 *
