...
public final class FlowStreamsContext {
    ...
    public FlowStreamsContext(Map<String, FlowStream<?>> streams) {
        // Ordered: iteration order reaches the pipeline spec and must be deterministic.
        this.streams = Collections.unmodifiableMap(new LinkedHashMap<>(streams));
    }
    ...
    /**
     * Returns all streams of this context keyed by stream id.
     *
