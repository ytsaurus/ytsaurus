...
public class Computation implements YTreeConvertible {
    ...
    protected void doProcessMessages(
        ...
        if (processFunction instanceof RowFunction rowFunction) {
            // Process messages.
        ...
        } else if (processFunction instanceof BatchFunction batchFunction) {
            // Process messages.
            if (!messages.isEmpty()) {
            ...
            throw new IllegalStateException(
                    "Unsupported ProcessFunction type: " + processFunction.getClass().getName());
        }
    }
