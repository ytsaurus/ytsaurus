...
public class PipelineSpecTestUtils {
     ...
     *
     * <p>A spec may declare no streams at all when the pipeline derives their schemas from the
     * registered message types; that yields an empty list rather than an error.
     *
    ...
    public static List<StreamInfo> extractStreamInfos(YTreeNode pipelineSpec) {
        ...
        return buildStreamInfos(streamSpecs.asMap());
    }
