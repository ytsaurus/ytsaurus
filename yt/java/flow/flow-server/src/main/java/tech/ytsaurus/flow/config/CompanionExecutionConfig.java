...
public record CompanionExecutionConfig(
    ...
    public CompanionExecutionConfig withPort(int newPort) {
        return new CompanionExecutionConfig(newPort, monitoringPort, clusterUrl, pipelinePath);
    }
    ...
    public static final class Builder {
        ...
        public CompanionExecutionConfig build() {
            return new CompanionExecutionConfig(port, monitoringPort, clusterUrl, pipelinePath);
        }
    }
}
