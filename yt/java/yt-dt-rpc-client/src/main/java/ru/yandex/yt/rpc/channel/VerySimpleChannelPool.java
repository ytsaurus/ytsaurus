/* Clone of SimpleChannelPool.java from netty ? */
/* TODO: why? */
 ...
 */
public class VerySimpleChannelPool implements ChannelPool {
    private static final AttributeKey<VerySimpleChannelPool> POOL_KEY = AttributeKey.newInstance("channelPool");
    private static final IllegalStateException FULL_EXCEPTION = ThrowableUtil.unknownStackTrace(
            new IllegalStateException("ChannelPool full"), VerySimpleChannelPool.class, "releaseAndOffer(...)");
    private static final IllegalStateException UNHEALTHY_NON_OFFERED_TO_POOL = ThrowableUtil.unknownStackTrace(
            ...
            VerySimpleChannelPool.class, "releaseAndOffer(...)");
     ...
     */
    public VerySimpleChannelPool(Bootstrap bootstrap, final ChannelPoolHandler handler) {
