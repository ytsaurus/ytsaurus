...
public class RichYPathTest {
    ...
    @Test
    public void child() {
        assertEquals(path(true, false, DEFAULT_RANGES, DEFAULT_COLUMNS, "/",
                        Arrays.asList("home", "sankear", "table", "2015-11-25"), false, DEFAULT_SORTED_BY,
                        DEFAULT_TIMESTAMP),
    ...
    public void after() {
        assertEquals(path(true, false, DEFAULT_RANGES, DEFAULT_COLUMNS, "/",
                        Arrays.asList("home", "sankear", "table", "after:12"), false, DEFAULT_SORTED_BY,
                        DEFAULT_TIMESTAMP),
    ...
    public void before() {
        assertEquals(path(true, false, DEFAULT_RANGES, DEFAULT_COLUMNS, "/",
                        Arrays.asList("home", "sankear", "table", "before:4243"), false, DEFAULT_SORTED_BY,
                        DEFAULT_TIMESTAMP),
    ...
    @Test
    public void append() {
        assertEquals(path(false, false, DEFAULT_RANGES, DEFAULT_COLUMNS, "/", DEFAULT_RELATIVE_PATH, false,
                        DEFAULT_SORTED_BY, DEFAULT_TIMESTAMP),
    ...
    @Test
    public void primary() {
        assertEquals(path(true, true, DEFAULT_RANGES, DEFAULT_COLUMNS, "/", DEFAULT_RELATIVE_PATH, false,
                        DEFAULT_SORTED_BY, DEFAULT_TIMESTAMP),
    ...
    @Test
    public void foreign() {
        assertEquals(path(true, false, DEFAULT_RANGES, DEFAULT_COLUMNS, "/", DEFAULT_RELATIVE_PATH, true,
                        DEFAULT_SORTED_BY, DEFAULT_TIMESTAMP),
    ...
    public void withRange() {
        assertEquals(path(
                        true, false,
                        Stream.concat(DEFAULT_RANGES.stream(), Stream.of(new Range(RangeLimit.row(19),
                                        RangeLimit.row(100))))
    ...
    public void withExact() {
        ...
        assertEquals(path(true, false, Stream.concat(DEFAULT_RANGES.stream(), Stream.of(new Exact(
    ...
    public void withTimestamp() {
        ...
        assertEquals(expected, defaultPath().withTimestamp(456));
    }

    @Test
    public void toTree() {
        assertEquals(defaultPath(), YPath.fromTree(defaultPath().toTree()));
        YPath path = path(true, false, List.of(), List.of(), "/", DEFAULT_RELATIVE_PATH, false, DEFAULT_SORTED_BY,
                DEFAULT_TIMESTAMP);
        assertEquals(path, YPath.fromTree(path.toTree()));
