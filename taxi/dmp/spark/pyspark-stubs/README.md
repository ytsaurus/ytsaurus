...
[![PyPI version](https://badge.fury.io/py/pyspark-stubs.svg)](https://badge.fury.io/py/pyspark-stubs)
...
- Static error detection (see [SPARK-20631](https://issues.apache.org/jira/browse/SPARK-20631))
...
Currently this project uses Spark 2.3 as a reference (work in progress).
