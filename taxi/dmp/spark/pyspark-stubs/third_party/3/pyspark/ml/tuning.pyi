...
class CrossValidatorModel(Model, _CrossValidatorParams, MLReadable[CrossValidatorModel], MLWritable):
    ...
    def setEstimator(self, value: Estimator) -> CrossValidatorModel: ...
    def setEstimatorParamMaps(self, value: List[ParamMap]) -> CrossValidatorModel: ...
    def setEvaluator(self, value: Evaluator) -> CrossValidatorModel: ...
