...
class Binarizer(JavaTransformer, HasThreshold, HasThresholds, HasInputCol, HasOutputCol, HasInputCols, HasOutputCols, JavaMLReadable[Binarizer], JavaMLWritable):
    ...
    @overload
    def __init__(self, *, thresholds: Optional[List[float]] = ..., inputCols: Optional[List[str]] = ..., outputCols: Optional[List[str]] = ...) -> None: ...
    @overload
...
class BucketedRandomProjectionLSH(_LSH[BucketedRandomProjectionLSHModel], _LSHParams, HasSeed, JavaMLReadable[BucketedRandomProjectionLSH], JavaMLWritable):
    ...
    def getBucketLength(self) -> float: ...
    def setInputCol(self, value: str) -> BucketedRandomProjectionLSH: ...
    def setOutputCol(self, value: str) -> BucketedRandomProjectionLSH: ...
...
class Imputer(JavaEstimator[ImputerModel], _ImputerParams, JavaMLReadable[Imputer], JavaMLWritable):
    @overload
    def __init__(self, *, strategy: str = ..., missingValue: float = ..., inputCols: Optional[List[str]] = ..., outputCols: Optional[List[str]] = ..., relativeError: float = ...) -> None: ...
    @overload
    def __init__(self, *, strategy: str = ..., missingValue: float = ..., inputCol: Optional[str] = ..., outputCol: Optional[str] = ..., relativeError: float = ...) -> None: ...
    @overload
    def setParams(self, *, strategy: str = ..., missingValue: float = ..., inputCols: Optional[List[str]] = ..., outputCols: Optional[List[str]] = ..., relativeError: float = ...) -> Imputer: ...
    @overload
    def setParams(self, *, strategy: str = ..., missingValue: float = ..., inputCol: Optional[str] = ..., outputCols: Optional[str] = ..., relativeError: float = ...) -> Imputer: ...
...
class Interaction(JavaTransformer, HasInputCols, HasOutputCol, JavaMLReadable[Interaction], JavaMLWritable):
    ...
    def setParams(self, *, inputCols: Optional[List[str]] = ..., outputCol: Optional[str] = ...) -> Interaction: ...
...
class OneHotEncoder(JavaEstimator[OneHotEncoderModel], _OneHotEncoderParams, JavaMLReadable[OneHotEncoder], JavaMLWritable):
    ...
    @overload
    def __init__(self, *, handleInvalid: str = ..., dropLast: bool = ..., inputCol: Optional[List[str]] = ..., outputCol: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def setParams(self, *, handleInvalid: str = ..., dropLast: bool = ..., inputCol: Optional[List[str]] = ..., outputCol: Optional[str] = ...) -> OneHotEncoder: ...
...
class QuantileDiscretizer(JavaEstimator[Bucketizer], HasInputCol, HasOutputCol, HasInputCols, HasOutputCols, HasHandleInvalid, HasRelativeError, JavaMLReadable[QuantileDiscretizer], JavaMLWritable):
...
class RobustScaler(JavaEstimator, _RobustScalerParams, JavaMLReadable[RobustScaler], JavaMLWritable):
    def __init__(self, *, lower: float = ..., upper: float = ..., withCentering: bool = ..., withScaling: bool = ..., inputCol: Optional[str] = ..., outputCol: Optional[str] = ..., relativeError: float = ...) -> None: ...
    def setParams(self, *, lower: float = ..., upper: float = ..., withCentering: bool = ..., withScaling: bool = ..., inputCol: Optional[str] = ..., outputCol: Optional[str] = ..., relativeError: float = ...) -> RobustScaler: ...
...
class StopWordsRemover(JavaTransformer, HasInputCol, HasOutputCol, HasInputCols, HasOutputCols, JavaMLReadable[StopWordsRemover], JavaMLWritable):
    ...
    @overload
    def __init__(self, *, stopWords: Optional[List[str]] = ..., caseSensitive: bool = ..., locale: Optional[str] = ..., inputCols: Optional[List[str]] = ..., outputCols: Optional[List[str]] = ...) -> None: ...
    @overload
    ...
    @overload
    def setParams(self, *, stopWords: Optional[List[str]] = ..., caseSensitive: bool = ..., locale: Optional[str] = ..., inputCols: Optional[List[str]] = ..., outputCols: Optional[List[str]] = ...) -> StopWordsRemover: ...
...
class ChiSqSelector(JavaEstimator[ChiSqSelectorModel], _ChiSqSelectorParams, JavaMLReadable[ChiSqSelector], JavaMLWritable):
...
class ChiSqSelectorModel(JavaModel, _ChiSqSelectorParams, JavaMLReadable[ChiSqSelectorModel], JavaMLWritable):
