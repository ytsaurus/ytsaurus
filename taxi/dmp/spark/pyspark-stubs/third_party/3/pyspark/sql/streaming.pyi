...
class DataStreamWriter:
    ...
    def start(self, path: Optional[str] = ..., format: Optional[str] = ..., partitionBy: Optional[Union[str, List[str]]] = ..., queryName: Optional[str] = ..., **options: str) -> StreamingQuery: ...
