...
class SparkSession:
    ...
    @overload
    def createDataFrame(self, data: Union[RDD[Union[Tuple, List]], Iterable[Union[Tuple, List]], pandas.core.frame.DataFrame], samplingRatio: Optional[float] = ...) -> DataFrame: ...
    @overload
    def createDataFrame(self, data: Union[RDD[Union[Tuple, List]], Iterable[Union[Tuple, List]], pandas.core.frame.DataFrame], schema: Optional[Union[List[str], Tuple[str, ...]]] = ..., samplingRatio: Optional[float] = ...) -> DataFrame: ...
    @overload
    def createDataFrame(self, data: Union[RDD[Union[DateTimeLiteral, LiteralType, DecimalLiteral]], Iterable[Union[DateTimeLiteral, LiteralType, DecimalLiteral]]], schema: DataType, verifySchema: bool = ...) -> DataFrame: ...
