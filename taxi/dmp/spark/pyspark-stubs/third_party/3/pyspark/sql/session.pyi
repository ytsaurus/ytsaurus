...
class SparkSession:
    ...
    def createDataFrame(self, data: Union[RDD[T], List[T], PandasDataFrame], schema: Optional[Union[List[str], DataType]] = ..., samplingRatio: Optional[float] = ..., verifySchema: bool = ...) -> DataFrame: ...
