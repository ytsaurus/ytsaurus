...
class DataFrame:
    ...
    def join(self, other: 'DataFrame', on: Optional[Union[str, List[str], Column]] = ..., how: Optional[str] = ...) -> 'DataFrame': ...
    ...
    @overload
    def select(self, cols: List[ColumnOrName]) -> 'DataFrame': ...
    @overload
    ...
    @overload
    def groupBy(self, cols: List[ColumnOrName]) -> 'DataFrame': ...
    @overload
    def rollup(self, *cols: ColumnOrName) -> 'DataFrame': ...
    @overload
    def rollup(self, cols: List[ColumnOrName]) -> 'DataFrame': ...
    @overload
    def cube(self, *cols: ColumnOrName) -> 'DataFrame': ...
    @overload
    def cube(self, cols: List[ColumnOrName]) -> 'DataFrame': ...
