...
class SQLContext:
    ...
    @overload
    def createDataFrame(self, data: Union[RDD[Union[Tuple, List]], Iterable[Union[Tuple, List]]], samplingRatio: Optional[float] = ...) -> DataFrame: ...
    @overload
    def createDataFrame(self, data: Union[RDD[Union[Tuple, List]], Iterable[Union[Tuple, List]]], schema: Union[List[str], Tuple[str, ...]] = ..., verifySchema: bool = ...) -> DataFrame: ...
    @overload
    ...
    @overload
    def createDataFrame(self, data: Union[RDD[Union[Tuple, List]], Iterable[Union[Tuple, List]]], schema: Union[StructType, str], verifySchema: bool = ...) -> DataFrame: ...
    @overload
