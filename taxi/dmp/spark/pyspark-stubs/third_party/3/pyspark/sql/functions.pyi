...
@overload
def pandas_udf(f: Callable[..., pandas.core.series.Series], returnType: StructField, functionType: int) -> Callable[..., ColumnOrName]: ...
@overload
def pandas_udf(f: Callable[[pandas.core.frame.DataFrame], pandas.core.frame.DataFrame], returnType: StructField, functionType: int) -> Callable[..., ColumnOrName]: ...  # type: ignore
