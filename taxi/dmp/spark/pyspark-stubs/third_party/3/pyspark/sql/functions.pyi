...
def to_date(col: ColumnOrName) -> Column: ...
@overload
...
@overload
def udf(f: Callable[[Any], Any], returnType: DataType = ...) -> Callable[[Column], Column]: ...
@overload
def udf(f: Callable[[Any, Any], Any], returnType: DataType = ...) -> Callable[[Column, Column], Column]: ...
@overload
def udf(f: Callable[[Any, Any, Any], Any], returnType: DataType = ...) -> Callable[[Column, Column, Column], Column]: ...
@overload
def udf(f: Callable[[Any, Any, Any, Any], Any], returnType: DataType = ...) -> Callable[[Column, Column, Column, Column], Column]: ...
@overload
def udf(f: Callable[[Any, Any, Any, Any, Any], Any], returnType: DataType = ...) -> Callable[[Column, Column, Column, Column, Column], Column]: ...
