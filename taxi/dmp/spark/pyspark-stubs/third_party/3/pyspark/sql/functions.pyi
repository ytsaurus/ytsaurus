...
def from_csv(col: ColumnOrName, schema: Union[StructType, Column, str], options: Dict[str, str] = ...) -> Column: ...
...
@overload
def pandas_udf(f: Union[AtomicDataTypeOrString, ArrayType], returnType: PandasScalarIterUDFType) -> Callable[[PandasScalarIterFunction], UserDefinedFunctionLike]: ...
@overload
def pandas_udf(*, returnType: Union[AtomicDataTypeOrString, ArrayType], functionType: PandasScalarIterUDFType) -> Callable[[PandasScalarIterFunction], UserDefinedFunctionLike]: ...
@overload
def pandas_udf(f: Union[AtomicDataTypeOrString, ArrayType], *, functionType: PandasScalarIterUDFType) -> Callable[[PandasScalarIterFunction], UserDefinedFunctionLike]: ...

@overload
def pandas_udf(f: PandasGroupedMapFunction, returnType: Union[StructType, str], functionType: PandasGroupedMapUDFType) -> GroupedMapPandasUserDefinedFunction: ...
@overload
def pandas_udf(f: Union[StructType, str], returnType: PandasGroupedMapUDFType) -> Callable[[PandasGroupedMapFunction], GroupedMapPandasUserDefinedFunction]: ...
@overload
def pandas_udf(*, returnType: Union[StructType, str], functionType: PandasGroupedMapUDFType) -> Callable[[PandasGroupedMapFunction], GroupedMapPandasUserDefinedFunction]: ...
@overload
def pandas_udf(f: Union[StructType, str], *, functionType: PandasGroupedMapUDFType) -> Callable[[PandasGroupedMapFunction], GroupedMapPandasUserDefinedFunction]: ...
...
@overload
def pandas_udf(f: Union[AtomicDataTypeOrString, ArrayType], returnType: PandasGroupedAggUDFType) -> Callable[[PandasGroupedAggFunction], UserDefinedFunctionLike]: ...
@overload
def pandas_udf(*, returnType: Union[AtomicDataTypeOrString, ArrayType], functionType: PandasGroupedAggUDFType) -> Callable[[PandasGroupedAggFunction], UserDefinedFunctionLike]: ...
@overload
def pandas_udf(f: Union[AtomicDataTypeOrString, ArrayType], *, functionType: PandasGroupedAggUDFType) -> Callable[[PandasGroupedAggFunction], UserDefinedFunctionLike]: ...
...
@overload
def pandas_udf(f: Union[StructType, str], returnType: PandasMapIterUDFType) -> Callable[[PandasMapIterFunction], MapIterPandasUserDefinedFunction]: ...
@overload
def pandas_udf(*, returnType: Union[StructType, str], functionType: PandasMapIterUDFType) -> Callable[[PandasMapIterFunction], MapIterPandasUserDefinedFunction]: ...
@overload
def pandas_udf(f: Union[StructType, str], *, functionType: PandasMapIterUDFType) -> Callable[[PandasMapIterFunction], MapIterPandasUserDefinedFunction]: ...

@overload
def pandas_udf(f: PandasCogroupedMapFunction, returnType: Union[StructType, str], functionType: PandasCogroupedMapUDFType) -> CogroupedMapPandasUserDefinedFunction: ...
@overload
def pandas_udf(f: Union[StructType, str], returnType: PandasCogroupedMapUDFType) -> Callable[[PandasCogroupedMapFunction], CogroupedMapPandasUserDefinedFunction]: ...
@overload
def pandas_udf(*, returnType: Union[StructType, str], functionType: PandasCogroupedMapUDFType) -> Callable[[PandasCogroupedMapFunction], CogroupedMapPandasUserDefinedFunction]: ...
@overload
def pandas_udf(f: Union[StructType, str], *, functionType: PandasCogroupedMapUDFType) -> Callable[[PandasCogroupedMapFunction], CogroupedMapPandasUserDefinedFunction]: ...
