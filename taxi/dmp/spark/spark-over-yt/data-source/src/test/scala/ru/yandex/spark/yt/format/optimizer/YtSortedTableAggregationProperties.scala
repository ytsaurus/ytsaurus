...
import ru.yandex.spark.yt.format.optimizer.YtSortedTableAggregationProperties.{AggTest, genAggTest}
import ru.yandex.spark.yt.format.optimizer.YtSortedTableBaseProperties._
