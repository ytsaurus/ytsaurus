...
//        .inLibrary("com.google.protobuf" % "protobuf-java" % "3.6.1")
//        .inLibrary("com.google.protobuf" % "protobuf-java" % "3.8.0"),
//      ShadeRule.rename("google.protobuf.**" -> "shaded.google.protobuf.@1")
//        .inLibrary("com.google.protobuf" % "protobuf-java" % "3.6.1")
//        .inLibrary("com.google.protobuf" % "protobuf-java" % "3.8.0")
    ),
    test in assembly := {}
