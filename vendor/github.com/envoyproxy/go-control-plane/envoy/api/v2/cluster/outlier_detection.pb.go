...
const file_envoy_api_v2_cluster_outlier_detection_proto_rawDesc = "" +
	"\n" +
	",envoy/api/v2/cluster/outlier_detection.proto\x12\x14envoy.api.v2.cluster\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xbe\x0f\n" +
	...
	"!failure_percentage_request_volume\x18\x14 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x1efailurePercentageRequestVolumeB\xd6\x01\xf2\x98\xfe\x8f\x05\x19\x12\x17envoy.config.cluster.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\"io.envoyproxy.envoy.api.v2.clusterB\x15OutlierDetectionProtoP\x01Z;github.com/envoyproxy/go-control-plane/envoy/api/v2/cluster\xaa\x02\x16Envoy.Api.V2.ClusterNS\xea\x02\x19Envoy::Api::V2::ClusterNSb\x06proto3"

var (
	file_envoy_api_v2_cluster_outlier_detection_proto_rawDescOnce sync.Once
	file_envoy_api_v2_cluster_outlier_detection_proto_rawDescData []byte
)
...
func file_envoy_api_v2_cluster_outlier_detection_proto_rawDescGZIP() []byte {
	file_envoy_api_v2_cluster_outlier_detection_proto_rawDescOnce.Do(func() {
		file_envoy_api_v2_cluster_outlier_detection_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_api_v2_cluster_outlier_detection_proto_rawDesc), len(file_envoy_api_v2_cluster_outlier_detection_proto_rawDesc)))
	})
...
var file_envoy_api_v2_cluster_outlier_detection_proto_goTypes = []any{
...
func file_envoy_api_v2_cluster_outlier_detection_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_api_v2_cluster_outlier_detection_proto_rawDesc), len(file_envoy_api_v2_cluster_outlier_detection_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
