...
const file_envoy_api_v2_core_backoff_proto_rawDesc = "" +
	"\n" +
	"\x1fenvoy/api/v2/core/backoff.proto\x12\x11envoy.api.v2.core\x1a\x1egoogle/protobuf/duration.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xa9\x01\n" +
	...
	"\fmax_interval\x18\x02 \x01(\v2\x19.google.protobuf.DurationB\b\xfaB\x05\xaa\x01\x02*\x00R\vmaxIntervalB\x8f\x01\xf2\x98\xfe\x8f\x05\x16\x12\x14envoy.config.core.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1fio.envoyproxy.envoy.api.v2.coreB\fBackoffProtoP\x01Z8github.com/envoyproxy/go-control-plane/envoy/api/v2/coreb\x06proto3"

var (
	file_envoy_api_v2_core_backoff_proto_rawDescOnce sync.Once
	file_envoy_api_v2_core_backoff_proto_rawDescData []byte
)

func file_envoy_api_v2_core_backoff_proto_rawDescGZIP() []byte {
	file_envoy_api_v2_core_backoff_proto_rawDescOnce.Do(func() {
		file_envoy_api_v2_core_backoff_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_api_v2_core_backoff_proto_rawDesc), len(file_envoy_api_v2_core_backoff_proto_rawDesc)))
	})
...
var file_envoy_api_v2_core_backoff_proto_goTypes = []any{
...
func file_envoy_api_v2_core_backoff_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_api_v2_core_backoff_proto_rawDesc), len(file_envoy_api_v2_core_backoff_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
