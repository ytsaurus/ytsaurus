...
exports.that = function Middleware__YtAcao()
{
    return function(req, rsp, next) {
        ...
        if (req.method === "OPTIONS") {
            ...
            rsp.setHeader("Access-Control-Allow-Headers", "authorization, origin, content-type, accept, x-yt-parameters, x-yt-parameters-0, x-yt-parameters-1, x-yt-input-format, x-yt-input-format-0, x-yt-output-format, x-yt-output-format-0, x-yt-header-format, x-yt-suppress-redirect");
