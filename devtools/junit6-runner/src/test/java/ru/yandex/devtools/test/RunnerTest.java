...
class RunnerTest {
    ...
    void testFilteringParameter(Class<?> testClass, TestResult expect, List<String> filters) throws Exception {
        Parameters parameters = new Parameters();
        parameters.filters = filters;
        TestResult actual = TestHelper.collectTestResult(runTest(testClass, parameters));
        TestHelper.dumpMismatchesIfRequired(expect, actual);
        Assertions.assertEquals(expect, actual);
        log.info("Test class checked: {}", testClass);
    }
    ...
    private List<String> runTest(Class<?> className) throws Exception {
        return runTest(className, new Parameters());
    }

    private List<String> runTest(Class<?> className, Parameters parameters) throws Exception {
    ...
    static Arguments[] testFilter() {
        return new Arguments[]{
                // filter with diff parameterized test by parameters
                Arguments.of(
                        ClassMethodsParameterizedConstantDisplayTest.class,
                        TestResult.notLaunched(2,
                                        "ru.yandex.devtools.test.ClassMethodsParameterizedConstantDisplayTest::Тест на проверку отображения и параметров:check [10]",
                                        "ru.yandex.devtools.test.ClassMethodsParameterizedConstantDisplayTest::Тест на проверку отображения и параметров:check [66]")
                                .withGood(2),
                        List.of("ru.yandex.devtools.test.ClassMethodsParameterizedConstantDisplayTest::Тест на проверку отображения и параметров:check [10]",
                                "ru.yandex.devtools.test.ClassMethodsParameterizedConstantDisplayTest::Тест на проверку отображения и параметров:check [66]"
                        )
                ),
                // with duplicate parameterized class and parameters(with display name for parameter and method)
                Arguments.of(
                        ParameterizedMethodDuplicateTest.class,
                        TestResult.notLaunched(2,
                                        "ru.yandex.devtools.test.ParameterizedMethodDuplicateTest::Тест на проверку отображения и параметров:check 5",
                                        "ru.yandex.devtools.test.ParameterizedMethodDuplicateTest::Тест на проверку отображения и параметров:check 10_1"
                                )
                                .withGood(2),
                        List.of(
                                "ru.yandex.devtools.test.ParameterizedMethodDuplicateTest::Тест на проверку отображения и параметров:check 5",
                ...
                Arguments.of(
                        ParameterizedMethodDuplicateTest.class,
                        TestResult.notLaunched(2,
                                        "ru.yandex.devtools.test.ParameterizedMethodDuplicateTest::Тест на проверку отображения и параметров:check 10",
                                        "ru.yandex.devtools.test.ParameterizedMethodDuplicateTest::Тест на проверку отображения и параметров:check 10_1"
                                )
                                .withGood(2),
                        List.of(
                ...
                Arguments.of(
                        ClassMethodsParameterizedConstantDisplayTest.class,
                        TestResult.notLaunched(1,
                                        "ru.yandex.devtools.test.ClassMethodsParameterizedConstantDisplayTest::Тест на проверку отображения и параметров:[2]"
                                )
                                .withGood(1),
                        List.of("ru.yandex.devtools.test.ClassMethodsParameterizedConstantDisplayTest::Тест на проверку отображения и параметров:[2]")
                ),
                // filter by class
                Arguments.of(ClassMethodsParameterizedConstantDisplayTest.class,
                        TestResult.good(6,
                                ...
                                "ru.yandex.devtools.test.ClassMethodsParameterizedConstantDisplayTest::Тест на проверку отображения и параметров:check [5]",
                                "ru.yandex.devtools.test.ClassMethodsParameterizedConstantDisplayTest::Тест на проверку отображения и параметров:check [66]"),
                        List.of("ru.yandex.devtools.test.ClassMethodsParameterizedConstantDisplayTest::*")
                ),
                // by simple method (without Display Name)
                Arguments.of(ClassTwoTest.class,
                        new TestResult(1, 1, 0, 0, 0,
                                List.of("ru.yandex.devtools.test.ClassTwoTest::test1()")),
                        List.of("ru.yandex.devtools.test.ClassTwoTest::test1()")
                ),
                // by simple method (with Display Name)
                Arguments.of(ClassMethodDisplayTest.class,
                        TestResult.good(1,
                                "ru.yandex.devtools.test.ClassMethodDisplayTest::Тест_1")
                        , List.of( "ru.yandex.devtools.test.ClassMethodDisplayTest::Тест_1")),
                Arguments.of(ClassMethodDisplayTest.class,
                        TestResult.good(2,
                                "ru.yandex.devtools.test.ClassMethodDisplayTest::Тест",
                                "ru.yandex.devtools.test.ClassMethodDisplayTest::Тест_1"
                ...
                // by simple method (ParameterizedTest)
                Arguments.of(ClassMethodsParameterizedConstantFailedTest.class,
                        TestResult.failed(3,
                                "ru.yandex.devtools.test.ClassMethodsParameterizedConstantFailedTest::test(int):[1] 1",
                                "ru.yandex.devtools.test.ClassMethodsParameterizedConstantFailedTest::test(int):[2] 2",
                                "ru.yandex.devtools.test.ClassMethodsParameterizedConstantFailedTest::test(int):[3] 3"),
                        List.of("ru.yandex.devtools.test.ClassMethodsParameterizedConstantFailedTest::test(int)")
                ),
        };
    }
    //CHECKSTYLE:ON
