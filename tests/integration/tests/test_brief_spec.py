...
def assert_attributes(op_id, options):
...
class TestBriefSpec(YTEnvSetup):
    ...
    def test_map(self):
        ...
        assert_attributes(op_id, ['mapper', 'input_table_path', 'output_table_path'])
    ...
    def test_sort(self):
        ...
        assert_attributes(op_id, ['input_table_path', 'output_table_path_1'])
    ...
    def test_reduce(self):
        ...
        assert_attributes(op_id, ['reducer', 'input_table_path', 'output_table_path'])        
    ...
    def test_map_reduce(self):
        ...
        assert_attributes(op_id, ['mapper', 'reducer', 'input_table_path', 'output_table_path'])   
    ...
    def test_erase(self):
        ...
        op_id = erase('//tmp/t1[#0:#0]')

        assert_attributes(op_id, ['table_path'])
