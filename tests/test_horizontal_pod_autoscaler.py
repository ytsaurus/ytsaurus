...
class TestHorizontalPodAutoscaler(object):
    def test_horizontal_pod_autoscaler(self, yp_env):
        ...
        replica_set_autoscale = {
            ...
            "check_extensible_field": {
                "random_key_1243": "value",
            },
        }
        ...
        horizontal_pod_autoscaler_id = yp_client.create_object(
            ...
            attributes={
                ...
                "spec": {
                    "replica_set": replica_set_autoscale
                }
            }
        )

        result = yp_client.get_object("horizontal_pod_autoscaler", horizontal_pod_autoscaler_id, selectors=["/meta", "/spec"])
        ...
        yp_client.update_object("horizontal_pod_autoscaler", horizontal_pod_autoscaler_id, set_updates=[{"path": "/status", "value": status}])

        result = yp_client.get_object("horizontal_pod_autoscaler", horizontal_pod_autoscaler_id, selectors=["/status"])[0]
    ...
    def test_remove_replica_set(self, yp_env):
        ...
        horizontal_pod_autoscaler_id = yp_client.create_object(object_type="horizontal_pod_autoscaler",
            attributes={
                "meta": {
                    "replica_set_id": replica_set_id
                }
        ...
        assert yp_client.get_object("horizontal_pod_autoscaler", horizontal_pod_autoscaler_id, selectors=["/meta/id"])[0] == horizontal_pod_autoscaler_id
