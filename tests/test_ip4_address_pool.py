...
class TestIP4AddressPools(object):
    ...
    def _create_pod_with_ip4_address_and_acl(self, yp_env, ip4_address, ace_action=None, ip4_address_pool_id=None):
        yp_client = yp_env.yp_client
        ...
        with yp_env.yp_instance.create_client(config={"user": user_name}) as yp_client:
            ...
            return create_pod_with_boilerplate(yp_client, pod_set_id, spec={
    ...
    def test_create_pool_as_user(self, yp_env):
        ...
        def allow_pool_creation(user_name):
            try:
                yp_client.update_object("schema", "ip4_address_pool", set_updates=[
                    {
                        "path": "/meta/acl/end",
                        "value": {
                            "action": "allow",
                ...
                yp_client.update_object("schema", "ip4_address_pool", remove_updates=[
                    {
                        "path": "/meta/acl/-1",
                    },
                ])
