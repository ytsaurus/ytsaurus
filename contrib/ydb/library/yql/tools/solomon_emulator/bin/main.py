...
from contrib.ydb.library.yql.tools.solomon_emulator.lib.config import Config
from contrib.ydb.library.yql.tools.solomon_emulator.lib.webapp import run_web_app
