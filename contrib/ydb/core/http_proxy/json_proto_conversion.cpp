...
void AddJsonObjectToProtoAsMap(
...
void JsonToProto(const NJson::TJsonValue& jsonValue, NProtoBuf::Message* message, ui32 depth) {
...
void NlohmannJsonToProto(const nlohmann::json& jsonValue, NProtoBuf::Message* message, ui32 depth) {
    Y_ENSURE(depth < 101, "Json depth is > 100");
    Y_ENSURE_EX(
        !jsonValue.is_null(),
        NKikimr::NSQS::TSQSException(NKikimr::NSQS::NErrors::MISSING_PARAMETER) <<
