...
struct TEvApplyLinksModification: public NActors::TEventPB<TEvApplyLinksModification,
                                      NKikimrColumnShardDataSharingProto::TEvApplyLinksModification, TEvColumnShard::EvApplyLinksModification> {
...
struct TEvApplyLinksModificationFinished
    : public NActors::TEventPB<TEvApplyLinksModificationFinished, NKikimrColumnShardDataSharingProto::TEvApplyLinksModificationFinished,
