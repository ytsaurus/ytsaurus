...
#include <contrib/ydb/core/tx/columnshard/data_sharing/destination/transactions/tx_data_from_source.h>
#include <contrib/ydb/core/tx/columnshard/data_sharing/destination/transactions/tx_finish_ack_from_initiator.h>
#include <contrib/ydb/core/tx/columnshard/data_sharing/destination/transactions/tx_finish_from_source.h>
...
NKikimr::TConclusion<std::unique_ptr<NTabletFlatExecutor::ITransaction>> TDestinationSession::ReceiveData(NColumnShard::TColumnShard* self,
    THashMap<ui64, NEvents::TPathIdData>&& data, std::vector<NOlap::TSchemaPresetVersionInfo>&& schemas, const ui32 receivedPackIdx, const TTabletId sourceTabletId,
