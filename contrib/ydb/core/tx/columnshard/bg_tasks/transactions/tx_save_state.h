...
#include <contrib/ydb/core/tx/columnshard/bg_tasks/session/session.h>
...
public:
    TTxSaveSessionState(const std::shared_ptr<TSession>& session, const std::optional<NActors::TActorId> progressActorId,
