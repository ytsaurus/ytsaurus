...
#include <contrib/ydb/core/formats/arrow/accessor/common/additional_data.h>
#include <contrib/ydb/core/formats/arrow/accessor/common/chunk_data.h>
#include <contrib/ydb/core/formats/arrow/accessor/composite_serial/accessor.h>
...
public:
    ...
    static TConclusion<std::shared_ptr<TPortionDataAccessor>> BuildFromProto(
