#include "index.h"
#include <contrib/ydb/core/tx/columnshard/engines/storage/actualizer/tiering/tiering.h>
#include <contrib/ydb/core/tx/columnshard/engines/storage/actualizer/scheme/scheme.h>
...
TGranuleActualizationIndex::TGranuleActualizationIndex(const TInternalPathId pathId, const TVersionedIndex& versionedIndex, const std::shared_ptr<IStoragesManager>& storagesManager)
    : PathId(pathId)
