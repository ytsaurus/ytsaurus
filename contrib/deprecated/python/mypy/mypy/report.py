...
class MemoryXmlReporter(AbstractReporter):
    ...
    def __init__(self, reports: Reports, output_dir: str) -> None:
        ...
        self.schema = etree.XMLSchema(etree.fromstring(arcadia_resfs.resfs_read(xsd_path)))
...
class XmlReporter(AbstractXmlReporter):
    ...
    def on_finish(self) -> None:
        ...
        last_xml.write(out_path, encoding='utf-8')
        with open(out_xslt, 'wb') as f:
            f.write(arcadia_resfs.resfs_read(self.memory_xml.xslt_html_path))
        with open(out_css, 'wb') as f:
            f.write(arcadia_resfs.resfs_read(self.memory_xml.css_html_path))
...
class XsltHtmlReporter(AbstractXmlReporter):
    ...
    def __init__(self, reports: Reports, output_dir: str) -> None:
        ...
        self.xslt_html = etree.XSLT(etree.fromstring(arcadia_resfs.resfs_read(self.memory_xml.xslt_html_path)))
