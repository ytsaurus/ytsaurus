...
def process_options(args: List[str],
    ...
    config_group.add_argument('--config-package')  # -> pkgutil, for internal use.
    ...
    config_package = dummy.config_package
    ...
    if config_package is None and config_file and not os.path.exists(config_file):
    ...
    parse_config_file(options, set_strict_flags, config_file, stdout, stderr, config_package)
