...
PY_SRCS(
    ...
    sqlalchemy/dialects/oracle/dictionary.py
    sqlalchemy/dialects/oracle/oracledb.py
    sqlalchemy/dialects/oracle/provision.py
    sqlalchemy/dialects/oracle/types.py
    sqlalchemy/dialects/oracle/vector.py
    sqlalchemy/dialects/postgresql/__init__.py
    sqlalchemy/dialects/postgresql/_psycopg_common.py
    ...
    sqlalchemy/dialects/postgresql/operators.py
    sqlalchemy/dialects/postgresql/pg8000.py
    sqlalchemy/dialects/postgresql/pg_catalog.py
    ...
    sqlalchemy/dialects/postgresql/types.py
    ...
    sqlalchemy/engine/_py_processors.py
    sqlalchemy/engine/_py_row.py
    sqlalchemy/engine/_py_util.py
    ...
    sqlalchemy/engine/processors.py
    ...
    sqlalchemy/orm/_orm_constructors.py
    sqlalchemy/orm/_typing.py
    sqlalchemy/orm/attributes.py
    sqlalchemy/orm/base.py
    sqlalchemy/orm/bulk_persistence.py
    ...
    sqlalchemy/orm/mapped_collection.py
    ...
    sqlalchemy/orm/state_changes.py
    ...
    sqlalchemy/sql/_dml_constructors.py
    sqlalchemy/sql/_elements_constructors.py
    sqlalchemy/sql/_orm_types.py
    sqlalchemy/sql/_py_util.py
    sqlalchemy/sql/_selectable_constructors.py
    sqlalchemy/sql/_typing.py
    sqlalchemy/sql/annotation.py
    sqlalchemy/sql/base.py
    sqlalchemy/sql/cache_key.py
    ...
    sqlalchemy/testing/fixtures/__init__.py
    sqlalchemy/testing/fixtures/base.py
    sqlalchemy/testing/fixtures/mypy.py
    sqlalchemy/testing/fixtures/orm.py
    sqlalchemy/testing/fixtures/sql.py
    ...
    sqlalchemy/cyextension/immutabledict.pyx
    sqlalchemy/cyextension/processors.pyx
    sqlalchemy/cyextension/resultproxy.pyx
    sqlalchemy/cyextension/util.pyx
)

RESOURCE_FILES(
    PREFIX contrib/python/sqlalchemy/sqlalchemy-2/
    .dist-info/METADATA
