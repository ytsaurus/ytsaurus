...
A Python library for the Docker Engine API. It lets you do anything the `docker` command does, but from within Python apps вЂ“ run containers, manage containers, manage Swarms, etc.
