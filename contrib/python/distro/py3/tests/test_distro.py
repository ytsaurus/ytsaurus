...
try:
    ...
    BASE = yatest.common.test_source_path()
except ImportError:
...
class TestCli:
    ...
    def _get_command(self):
        try:
            import yatest.common
            return [yatest.common.binary_path('contrib/python/distro/py3/bin/distro')]
        except ImportError:
            return [sys.executable, '-m', 'distro']
