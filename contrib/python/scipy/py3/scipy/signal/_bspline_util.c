...
#ifdef __GNUC__
void C_IIR_order1(__complex__ float a1, __complex__ float a2, __complex__ float *x, __complex__ float *y,
...
#endif
#ifdef __GNUC__
void Z_IIR_order1(__complex__ double a1, __complex__ double a2, __complex__ double *x, __complex__ double *y,
             int N, int stridex, int stridey)
{
...
#ifdef __GNUC__
void C_IIR_order2(__complex__ float a1, __complex__ float a2, __complex__ float a3,
             __complex__ float *x, __complex__ float *y, int N, int stridex, int stridey)
{
...
#endif
#ifdef __GNUC__
void Z_IIR_order2(__complex__ double a1, __complex__ double a2, __complex__ double a3,
             __complex__ double *x, __complex__ double *y, int N, int stridex, int stridey)
{
...
#ifdef __GNUC__
void C_IIR_order2_cascade(__complex__ float cs, __complex__ float z1, __complex__ float z2,
                     __complex__ float y1_0, __complex__ float *x, __complex__ float *yp,
                     int N, int stridex, int stridey)
{
...
#endif
#ifdef __GNUC__
void Z_IIR_order2_cascade(__complex__ double cs, __complex__ double z1, __complex__ double z2,
                     __complex__ double y1_0, __complex__ double *x, __complex__ double *yp,
                     int N, int stridex, int stridey)
{
                   ...
                   int N, int stridex, int stridey, float precision)
{
    ...
    __complex__ float yp0, powz1, diff;
    float err;
    int k;
