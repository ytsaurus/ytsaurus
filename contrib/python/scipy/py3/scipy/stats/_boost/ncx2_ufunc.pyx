...
cdef extern from "boost/math/distributions/non_central_chi_squared.hpp" namespace "boost::math" nogil:
    cdef cppclass non_central_chi_squared_distribution nogil:
        pass
...
func0[0] = <void*>boost_pdf2[non_central_chi_squared_distribution, float, float, float]
...
func0[1] = <void*>boost_pdf2[non_central_chi_squared_distribution, double, double, double]
types0[0+1*4] = NPY_DOUBLE
types0[1+1*4] = NPY_DOUBLE
types0[2+1*4] = NPY_DOUBLE
types0[3+1*4] = NPY_DOUBLE

_ncx2_pdf = PyUFunc_FromFuncAndData(
    loop_func0,
    func0,
    types0,
    ...
    "_ncx2_pdf",  # function name
    ("_ncx2_pdf(x, df, nc) -> computes "
     "pdf of ncx2 distribution"),
    0  # unused
)
...
func1[0] = <void*>boost_cdf2[non_central_chi_squared_distribution, float, float, float]
...
func1[1] = <void*>boost_cdf2[non_central_chi_squared_distribution, double, double, double]
types1[0+1*4] = NPY_DOUBLE
types1[1+1*4] = NPY_DOUBLE
types1[2+1*4] = NPY_DOUBLE
types1[3+1*4] = NPY_DOUBLE

_ncx2_cdf = PyUFunc_FromFuncAndData(
    loop_func1,
    func1,
    types1,
    2,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_ncx2_cdf",  # function name
    ("_ncx2_cdf(x, df, nc) -> computes "
     "cdf of ncx2 distribution"),
    0  # unused
)
...
func2[0] = <void*>boost_sf2[non_central_chi_squared_distribution, float, float, float]
...
func2[1] = <void*>boost_sf2[non_central_chi_squared_distribution, double, double, double]
types2[0+1*4] = NPY_DOUBLE
types2[1+1*4] = NPY_DOUBLE
types2[2+1*4] = NPY_DOUBLE
types2[3+1*4] = NPY_DOUBLE

_ncx2_sf = PyUFunc_FromFuncAndData(
    loop_func2,
    func2,
    types2,
    2,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_ncx2_sf",  # function name
    ("_ncx2_sf(x, df, nc) -> computes "
     "sf of ncx2 distribution"),
    0  # unused
)
...
func3[0] = <void*>boost_ppf2[non_central_chi_squared_distribution, float, float, float]
...
func3[1] = <void*>boost_ppf2[non_central_chi_squared_distribution, double, double, double]
types3[0+1*4] = NPY_DOUBLE
types3[1+1*4] = NPY_DOUBLE
types3[2+1*4] = NPY_DOUBLE
types3[3+1*4] = NPY_DOUBLE

_ncx2_ppf = PyUFunc_FromFuncAndData(
    loop_func3,
    func3,
    types3,
    2,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_ncx2_ppf",  # function name
    ("_ncx2_ppf(x, df, nc) -> computes "
     "ppf of ncx2 distribution"),
    0  # unused
)
...
func4[0] = <void*>boost_isf2[non_central_chi_squared_distribution, float, float, float]
...
func4[1] = <void*>boost_isf2[non_central_chi_squared_distribution, double, double, double]
types4[0+1*4] = NPY_DOUBLE
types4[1+1*4] = NPY_DOUBLE
types4[2+1*4] = NPY_DOUBLE
types4[3+1*4] = NPY_DOUBLE

_ncx2_isf = PyUFunc_FromFuncAndData(
    loop_func4,
    func4,
    types4,
    2,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_ncx2_isf",  # function name
    ("_ncx2_isf(x, df, nc) -> computes "
     "isf of ncx2 distribution"),
    0  # unused
)
...
func5[0] = <void*>boost_mean2[non_central_chi_squared_distribution, float, float, float]
...
func5[1] = <void*>boost_mean2[non_central_chi_squared_distribution, double, double, double]
types5[0+1*3] = NPY_DOUBLE
types5[1+1*3] = NPY_DOUBLE
types5[2+1*3] = NPY_DOUBLE

_ncx2_mean = PyUFunc_FromFuncAndData(
    loop_func5,
    func5,
    types5,
    2,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_ncx2_mean",  # function name
    ("_ncx2_mean(df, nc) -> computes "
     "mean of ncx2 distribution"),
    0  # unused
)
...
func6[0] = <void*>boost_variance2[non_central_chi_squared_distribution, float, float, float]
...
func6[1] = <void*>boost_variance2[non_central_chi_squared_distribution, double, double, double]
types6[0+1*3] = NPY_DOUBLE
types6[1+1*3] = NPY_DOUBLE
types6[2+1*3] = NPY_DOUBLE

_ncx2_variance = PyUFunc_FromFuncAndData(
    loop_func6,
    func6,
    types6,
    2,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_ncx2_variance",  # function name
    ("_ncx2_variance(df, nc) -> computes "
     "variance of ncx2 distribution"),
    0  # unused
)
...
func7[0] = <void*>boost_skewness2[non_central_chi_squared_distribution, float, float, float]
...
func7[1] = <void*>boost_skewness2[non_central_chi_squared_distribution, double, double, double]
types7[0+1*3] = NPY_DOUBLE
types7[1+1*3] = NPY_DOUBLE
types7[2+1*3] = NPY_DOUBLE

_ncx2_skewness = PyUFunc_FromFuncAndData(
    loop_func7,
    func7,
    types7,
    2,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_ncx2_skewness",  # function name
    ("_ncx2_skewness(df, nc) -> computes "
     "skewness of ncx2 distribution"),
    0  # unused
)
...
func8[0] = <void*>boost_kurtosis_excess2[non_central_chi_squared_distribution, float, float, float]
...
func8[1] = <void*>boost_kurtosis_excess2[non_central_chi_squared_distribution, double, double, double]
types8[0+1*3] = NPY_DOUBLE
types8[1+1*3] = NPY_DOUBLE
types8[2+1*3] = NPY_DOUBLE

_ncx2_kurtosis_excess = PyUFunc_FromFuncAndData(
    loop_func8,
    func8,
    types8,
    2,  # number of supported input types
    ...
    1,  # number of output args
    PyUFunc_None,  # `identity` element, never mind this
    "_ncx2_kurtosis_excess",  # function name
    ("_ncx2_kurtosis_excess(df, nc) -> computes "
     "kurtosis_excess of ncx2 distribution"),
    0  # unused
)
