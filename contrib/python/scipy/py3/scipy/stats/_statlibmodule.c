...
extern void F_WRAPPEDFUNC(prho,PRHO)(double*,int*,int*,int*);
/*eof externroutines*/
...
/*frompyobj*/
    ...
    if (f2py_success) {
    /* Processing variable ifault */
    /* Processing variable prho */
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
#endif
/*callfortranroutine*/
    (*f2py_func)(&prho,&n,&is,&ifault);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("di",prho,ifault);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    /* End of cleaning variable prho */
    /* End of cleaning variable ifault */
...
static FortranDataDef f2py_routine_defs[] = {
    ...
    {"prho",-1,{{-1}},0,0,(char *)  F_WRAPPEDFUNC(prho,PRHO),  (f2py_init_func)f2py_rout__statlib_prho,doc_f2py_rout__statlib_prho},
...
".");
    ...
    {
      extern double F_FUNC(prho,PRHO)(void);
      PyObject* o = PyDict_GetItemString(d,"prho");
      tmp = F2PyCapsule_FromVoidPtr((void*)F_FUNC(prho,PRHO),NULL);
      PyObject_SetAttrString(o,"_cpointer", tmp);
      Py_DECREF(tmp);
      s = PyUnicode_FromString("prho");
