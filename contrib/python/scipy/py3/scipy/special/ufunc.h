...
static PyObject *SpecFun_NewUFunc(SpecFun_UFunc func, int nout, const char *name, const char *doc) {
...
static PyObject *SpecFun_NewUFunc(SpecFun_UFunc func, const char *name, const char *doc) {
    int nout = func.has_return();

    return SpecFun_NewUFunc(std::move(func), nout, name, doc);
}

static PyObject *SpecFun_NewGUFunc(SpecFun_UFunc func, int nout, const char *name, const char *doc, const char *signature) {
    static std::vector<SpecFun_UFunc> ufuncs;
...
static PyObject *SpecFun_NewGUFunc(SpecFun_UFunc func, const char *name, const char *doc, const char *signature) {
    int nout = func.has_return();
