...
namespace cephes {
    ...
    namespace detail {
        ...
        static XSF_HOST_DEVICE double hyp2f1ra(double a, double b, double c, double x, double *loss);

        /* Defining power series expansion of Gauss hypergeometric function */
        /* The `loss` parameter estimates loss of significance */
        static XSF_HOST_DEVICE double hys2f1(double a, double b, double c, double x, double *loss) {
        ...
        static XSF_HOST_DEVICE double hyt2f1(double a, double b, double c, double x, double *loss) {
        ...
        */
        static XSF_HOST_DEVICE double hyp2f1_neg_c_equal_bc(double a, double b, double x) {
            double k;
            double collector = 1;
            double sum = 1;
    ...
    static XSF_HOST_DEVICE double hyp2f1(double a, double b, double c, double x) {
        double d, d1, d2, e;
        double p, q, r, s, y, ax;
