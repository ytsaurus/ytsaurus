...
static double struve_h(double v, double z) { return cephes::struve_h(v, z); }

static float struve_h(float v, float z) { return struve_h(static_cast<double>(v), static_cast<double>(z)); }

static double struve_l(double v, double z) { return cephes::struve_l(v, z); }

static float struve_l(float v, float z) { return struve_l(static_cast<double>(v), static_cast<double>(z)); }
