...
namespace cephes {
    ...
    namespace detail {
        ...
        static SPECFUN_HOST_DEVICE double lanczos_sum(double x) { return ratevl(x, lanczos_num, 12, lanczos_denom, 12); }

        static SPECFUN_HOST_DEVICE double lanczos_sum_near_1(double dx) {
            double result = 0;
            unsigned k;
        ...
        static SPECFUN_HOST_DEVICE double lanczos_sum_near_2(double dx) {
            double result = 0;
            double x = dx + 2;
            unsigned k;
    ...
    static SPECFUN_HOST_DEVICE double lanczos_sum_expg_scaled(double x) {
