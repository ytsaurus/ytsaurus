...
namespace cephes {
    namespace detail {
        ...
        static SPECFUN_HOST_DEVICE double digamma_imp_1_2(double x) {
            /*
        ...
        static SPECFUN_HOST_DEVICE double psi_asy(double x) {
            double y, z;
    ...
    static SPECFUN_HOST_DEVICE double psi(double x) {
        double y = 0.0;
        double q, r;
        int i, n;
