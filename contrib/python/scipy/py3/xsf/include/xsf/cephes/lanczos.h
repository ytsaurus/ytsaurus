...
namespace cephes {
    ...
    namespace detail {
        ...
        constexpr double lanczos_sum_expg_scaled_denom[] = {1,         66,       1925,     32670,     357423,
                                                            2637558,   13339535, 45995730, 105258076, 150917976,
                                                            120543840, 39916800, 0};
        ...
        static XSF_HOST_DEVICE double lanczos_sum(double x) { return ratevl(x, lanczos_num, 12, lanczos_denom, 12); }

        static XSF_HOST_DEVICE double lanczos_sum_near_1(double dx) {
            double result = 0;
            unsigned k;
        ...
        static XSF_HOST_DEVICE double lanczos_sum_near_2(double dx) {
            double result = 0;
            double x = dx + 2;
            unsigned k;
    ...
    static XSF_HOST_DEVICE double lanczos_sum_expg_scaled(double x) {
