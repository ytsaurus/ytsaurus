...
namespace cephes {
    ...
    namespace detail {
        ...
        static XSF_HOST_DEVICE double_double pow_D(const double_double &a, int m) {
            /*
        ...
        static XSF_HOST_DEVICE double_double pow2Scaled_D(const double_double &a, int m, int *pExponent) {
