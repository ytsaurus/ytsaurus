...
namespace detail {
    ...
    static XSF_HOST_DEVICE std::complex<double> loggamma_stirling(std::complex<double> z) {
    ...
    static XSF_HOST_DEVICE std::complex<double> loggamma_recurrence(std::complex<double> z) {
    ...
    static XSF_HOST_DEVICE std::complex<double> loggamma_taylor(std::complex<double> z) {
