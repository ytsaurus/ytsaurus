...
#include "DBPoco/Data/Transaction.h"
...
Transaction::Transaction(DBPoco::Data::Session& rSession, DBPoco::Logger* pLogger):
	_rSession(rSession),
	_pLogger(pLogger)
{
	begin();
...
Transaction::Transaction(DBPoco::Data::Session& rSession, bool start):
	_rSession(rSession),
	_pLogger(0)
{
	if (start) begin();
