...
#ifndef DB_Data_Statement_INCLUDED
#define DB_Data_Statement_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        Statement & operator,(DBPoco::UInt8 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.

        Statement & operator,(DBPoco::Int8 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.

        Statement & operator,(DBPoco::UInt16 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.

        Statement & operator,(DBPoco::Int16 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.

        Statement & operator,(DBPoco::UInt32 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.

        Statement & operator,(DBPoco::Int32 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.
        ...
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.
#endif
        Statement & operator,(DBPoco::UInt64 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.

        Statement & operator,(DBPoco::Int64 value);
        /// Adds the value to the list of values to be supplied to the SQL string formatting function.
    ...
    inline Statement &Statement::operator,(DBPoco::UInt8 value)
    {
        return commaPODImpl(value);
    }


    inline Statement &Statement::operator,(DBPoco::Int8 value)
    {
        return commaPODImpl(value);
    }


    inline Statement &Statement::operator,(DBPoco::UInt16 value)
    {
        return commaPODImpl(value);
    }


    inline Statement &Statement::operator,(DBPoco::Int16 value)
    {
        return commaPODImpl(value);
    }


    inline Statement &Statement::operator,(DBPoco::UInt32 value)
    {
        return commaPODImpl(value);
    }


    inline Statement &Statement::operator,(DBPoco::Int32 value)
    {
        return commaPODImpl(value);
    }
    ...
    inline Statement &Statement::operator,(DBPoco::UInt64 value)
    {
        return commaPODImpl(value);
    }


    inline Statement &Statement::operator,(DBPoco::Int64 value)
    {
        return commaPODImpl(value);
    }
...
{
template <>
inline void swap<DBPoco::Data::Statement>(DBPoco::Data::Statement & s1, DBPoco::Data::Statement & s2)
...
#endif // DB_Data_Statement_INCLUDED
