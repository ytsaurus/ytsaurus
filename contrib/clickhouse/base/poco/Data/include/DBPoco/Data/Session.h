...
#ifndef DB_Data_Session_INCLUDED
#define DB_Data_Session_INCLUDED


#include <algorithm>
#include "DBPoco/Any.h"
#include "DBPoco/AutoPtr.h"
#include "DBPoco/Data/Binding.h"
...
namespace Data
{
    ...
    public:
        ...
        static const DBPoco::UInt32 TRANSACTION_READ_UNCOMMITTED = 0x00000001L;
        static const DBPoco::UInt32 TRANSACTION_READ_COMMITTED = 0x00000002L;
        static const DBPoco::UInt32 TRANSACTION_REPEATABLE_READ = 0x00000004L;
        static const DBPoco::UInt32 TRANSACTION_SERIALIZABLE = 0x00000008L;

        Session(DBPoco::AutoPtr<SessionImpl> ptrImpl);
        /// Creates the Session.
        ...
        bool hasTransactionIsolation(DBPoco::UInt32 ti);
        /// Returns true iff the transaction isolation level corresponding
        /// to the supplied bitmask is supported.

        bool isTransactionIsolation(DBPoco::UInt32 ti);
        ...
        DBPoco::Any getProperty(const std::string & name) const;
    ...
    inline void Session::setTransactionIsolation(DBPoco::UInt32 ti)
    {
        _pImpl->setTransactionIsolation(ti);
    }


    inline DBPoco::UInt32 Session::getTransactionIsolation()
    {
        return _pImpl->getTransactionIsolation();
    }


    inline bool Session::hasTransactionIsolation(DBPoco::UInt32 ti)
    {
        return _pImpl->hasTransactionIsolation(ti);
    }


    inline bool Session::isTransactionIsolation(DBPoco::UInt32 ti)
    {
    ...
    inline void Session::setProperty(const std::string & name, const DBPoco::Any & value)
    {
        _pImpl->setProperty(name, value);
    }


    inline DBPoco::Any Session::getProperty(const std::string & name) const
    {
...
{
template <>
inline void swap<DBPoco::Data::Session>(DBPoco::Data::Session & s1, DBPoco::Data::Session & s2)
...
#endif // DB_Data_Session_INCLUDED
