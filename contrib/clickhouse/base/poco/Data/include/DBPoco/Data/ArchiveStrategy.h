...
#ifndef DB_Data_ArchiveStrategy_INCLUDED
#define DB_Data_ArchiveStrategy_INCLUDED
...
namespace Data
{
    ...
    protected:
        typedef DBPoco::SharedPtr<Session> SessionPtr;
        typedef DBPoco::SharedPtr<Statement> StatementPtr;
    ...
    private:
        ...
        DBPoco::Dynamic::Var _archiveCount;
    };
...
#endif // DB_Data_ArchiveStrategy_INCLUDED
