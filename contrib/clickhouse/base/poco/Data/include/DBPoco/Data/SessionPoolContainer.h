...
#ifndef DB_Data_SessionPoolContainer_INCLUDED
#define DB_Data_SessionPoolContainer_INCLUDED
...
namespace Data
{
    ...
    private:
        typedef std::map<std::string, AutoPtr<SessionPool>, DBPoco::CILess> SessionPoolMap;
...
#endif // DB_Data_SessionPoolContainer_INCLUDED
