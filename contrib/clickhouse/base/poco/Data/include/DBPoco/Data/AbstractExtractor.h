...
#ifndef DB_Data_AbstractExtractor_INCLUDED
#define DB_Data_AbstractExtractor_INCLUDED
...
#include <string>
#include <vector>
#include "DBPoco/Data/Constants.h"
...
namespace Data
{
    ...
    public:
        ...
        virtual bool extract(std::size_t pos, DBPoco::Int8 & val) = 0;
        /// Extracts an Int8. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<DBPoco::Int8> & val);
        /// Extracts an Int8 vector.

        virtual bool extract(std::size_t pos, std::deque<DBPoco::Int8> & val);
        /// Extracts an Int8 deque.

        virtual bool extract(std::size_t pos, std::list<DBPoco::Int8> & val);
        /// Extracts an Int8 list.

        virtual bool extract(std::size_t pos, DBPoco::UInt8 & val) = 0;
        /// Extracts an UInt8. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<DBPoco::UInt8> & val);
        /// Extracts an UInt8 vector.

        virtual bool extract(std::size_t pos, std::deque<DBPoco::UInt8> & val);
        /// Extracts an UInt8 deque.

        virtual bool extract(std::size_t pos, std::list<DBPoco::UInt8> & val);
        /// Extracts an UInt8 list.

        virtual bool extract(std::size_t pos, DBPoco::Int16 & val) = 0;
        /// Extracts an Int16. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<DBPoco::Int16> & val);
        /// Extracts an Int16 vector.

        virtual bool extract(std::size_t pos, std::deque<DBPoco::Int16> & val);
        /// Extracts an Int16 deque.

        virtual bool extract(std::size_t pos, std::list<DBPoco::Int16> & val);
        /// Extracts an Int16 list.

        virtual bool extract(std::size_t pos, DBPoco::UInt16 & val) = 0;
        /// Extracts an UInt16. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<DBPoco::UInt16> & val);
        /// Extracts an UInt16 vector.

        virtual bool extract(std::size_t pos, std::deque<DBPoco::UInt16> & val);
        /// Extracts an UInt16 deque.

        virtual bool extract(std::size_t pos, std::list<DBPoco::UInt16> & val);
        /// Extracts an UInt16 list.

        virtual bool extract(std::size_t pos, DBPoco::Int32 & val) = 0;
        /// Extracts an Int32. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<DBPoco::Int32> & val);
        /// Extracts an Int32 vector.

        virtual bool extract(std::size_t pos, std::deque<DBPoco::Int32> & val);
        /// Extracts an Int32 deque.

        virtual bool extract(std::size_t pos, std::list<DBPoco::Int32> & val);
        /// Extracts an Int32 list.

        virtual bool extract(std::size_t pos, DBPoco::UInt32 & val) = 0;
        /// Extracts an UInt32. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<DBPoco::UInt32> & val);
        /// Extracts an UInt32 vector.

        virtual bool extract(std::size_t pos, std::deque<DBPoco::UInt32> & val);
        /// Extracts an UInt32 deque.

        virtual bool extract(std::size_t pos, std::list<DBPoco::UInt32> & val);
        /// Extracts an UInt32 list.

        virtual bool extract(std::size_t pos, DBPoco::Int64 & val) = 0;
        /// Extracts an Int64. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<DBPoco::Int64> & val);
        /// Extracts an Int64 vector.

        virtual bool extract(std::size_t pos, std::deque<DBPoco::Int64> & val);
        /// Extracts an Int64 deque.

        virtual bool extract(std::size_t pos, std::list<DBPoco::Int64> & val);
        /// Extracts an Int64 list.

        virtual bool extract(std::size_t pos, DBPoco::UInt64 & val) = 0;
        /// Extracts an UInt64. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<DBPoco::UInt64> & val);
        /// Extracts an UInt64 vector.

        virtual bool extract(std::size_t pos, std::deque<DBPoco::UInt64> & val);
        /// Extracts an UInt64 deque.

        virtual bool extract(std::size_t pos, std::list<DBPoco::UInt64> & val);
        ...
        virtual bool extract(std::size_t pos, DBPoco::Dynamic::Var & val) = 0;
        /// Extracts a Var. Returns false if null was received.

        virtual bool extract(std::size_t pos, std::vector<DBPoco::Dynamic::Var> & val);
        /// Extracts a Var vector.

        virtual bool extract(std::size_t pos, std::deque<DBPoco::Dynamic::Var> & val);
        /// Extracts a Var deque.

        virtual bool extract(std::size_t pos, std::list<DBPoco::Dynamic::Var> & val);
        /// Extracts a Var list.
...
#endif // DB_Data_AbstractExtractor_INCLUDED
