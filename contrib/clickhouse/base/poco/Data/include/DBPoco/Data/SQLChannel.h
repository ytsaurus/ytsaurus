...
#ifndef DB_Data_SQLChannel_INCLUDED
#define DB_Data_SQLChannel_INCLUDED
...
namespace Data
{
    ...
    class Data_API SQLChannel : public DBPoco::Channel
    ...
    private:
        ...
        typedef DBPoco::Message::Priority Priority;
        typedef DBPoco::SharedPtr<ArchiveStrategy> StrategyPtr;
...
#endif // DB_Data_SQLChannel_INCLUDED
