...
#ifndef DB_Data_RowFormatter_INCLUDED
#define DB_Data_RowFormatter_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        typedef std::vector<DBPoco::Dynamic::Var> ValueVec;
...
#endif // DB_Data_RowFormatter_INCLUDED
