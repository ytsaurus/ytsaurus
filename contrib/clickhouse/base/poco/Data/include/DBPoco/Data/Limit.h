...
#ifndef DB_Data_Limit_INCLUDED
#define DB_Data_Limit_INCLUDED
...
namespace Data
{
    ...
    // inlines
    //
    inline DBPoco::UInt32 Limit::value() const
    {
        return _value;
    }
