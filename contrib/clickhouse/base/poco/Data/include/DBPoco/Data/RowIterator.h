...
#ifndef DB_Data_RowIterator_INCLUDED
#define DB_Data_RowIterator_INCLUDED
...
{
template <>
inline void swap<DBPoco::Data::RowIterator>(DBPoco::Data::RowIterator & s1, DBPoco::Data::RowIterator & s2)
...
#endif // DB_Data_RowIterator_INCLUDED
