...
#ifndef DB_Data_RowFilter_INCLUDED
#define DB_Data_RowFilter_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        typedef bool (*CompT)(const DBPoco::Dynamic::Var &, const DBPoco::Dynamic::Var &);
        typedef AutoPtr<RowFilter> Ptr;
        typedef std::map<std::string, Comparison> Comparisons;
        typedef Tuple<DBPoco::Dynamic::Var, Comparison, LogicOperator> ComparisonEntry;
    ...
    private:
        ...
        static bool equal(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2);
        static bool notEqual(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2);
        static bool less(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2);
        static bool greater(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2);
        static bool lessOrEqual(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2);
        static bool greaterOrEqual(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2);
        static bool logicalAnd(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2);
        static bool logicalOr(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2);
        static bool isNull(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var &);

        static void doCompare(DBPoco::Dynamic::Var & ret, DBPoco::Dynamic::Var & val, CompT comp, const ComparisonEntry & ce);
    ...
    inline bool RowFilter::equal(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2)
    {
        return p1 == p2;
    }


    inline bool RowFilter::notEqual(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2)
    {
        return p1 != p2;
    }


    inline bool RowFilter::less(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2)
    {
        return p1 < p2;
    }


    inline bool RowFilter::greater(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2)
    {
        return p1 > p2;
    }


    inline bool RowFilter::lessOrEqual(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2)
    {
        return p1 <= p2;
    }


    inline bool RowFilter::greaterOrEqual(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2)
    {
        return p1 >= p2;
    }


    inline bool RowFilter::logicalAnd(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2)
    {
        return p1 && p2;
    }


    inline bool RowFilter::logicalOr(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var & p2)
    {
        return p1 || p2;
    }


    inline bool RowFilter::isNull(const DBPoco::Dynamic::Var & p1, const DBPoco::Dynamic::Var &)
    {
        return p1.isEmpty();
    }
...
#endif // DB_Data_RowFilter_INCLUDED
