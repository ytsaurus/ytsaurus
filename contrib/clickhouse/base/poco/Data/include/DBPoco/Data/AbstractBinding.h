...
#ifndef DB_Data_AbstractBinding_INCLUDED
#define DB_Data_AbstractBinding_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        AbstractBinding(const std::string & name = "", Direction direction = PD_IN, DBPoco::UInt32 bulkSize = 0);
    ...
    inline DBPoco::UInt32 AbstractBinding::bulkSize() const
    {
        return _bulkSize;
    }
...
#endif // DB_Data_AbstractBinding_INCLUDED
