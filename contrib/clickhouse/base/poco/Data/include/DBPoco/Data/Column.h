...
#ifndef DB_Data_Column_INCLUDED
#define DB_Data_Column_INCLUDED
...
namespace Data
{
    ...
    public:
        typedef C Container;
        typedef DBPoco::SharedPtr<C> ContainerPtr;
    ...
    public:
        ...
        typedef DBPoco::SharedPtr<Container> ContainerPtr;
