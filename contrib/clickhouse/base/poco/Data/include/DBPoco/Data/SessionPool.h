...
#ifndef DB_Data_SessionPool_INCLUDED
#define DB_Data_SessionPool_INCLUDED
...
namespace Data
{
    ...
    protected:
        ...
        typedef DBPoco::AutoPtr<PooledSessionHolder> PooledSessionHolderPtr;
        typedef DBPoco::AutoPtr<PooledSessionImpl> PooledSessionImplPtr;
        typedef std::list<PooledSessionHolderPtr> SessionList;
        typedef DBPoco::HashMap<std::string, bool> FeatureMap;
        typedef DBPoco::HashMap<std::string, DBPoco::Any> PropertyMap;
        ...
        void onJanitorTimer(DBPoco::Timer &);

    private:
        typedef std::pair<std::string, DBPoco::Any> PropertyPair;
...
#endif // DB_Data_SessionPool_INCLUDED
