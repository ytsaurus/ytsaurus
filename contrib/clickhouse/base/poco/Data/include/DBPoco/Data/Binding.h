...
#ifndef DB_Data_Binding_INCLUDED
#define DB_Data_Binding_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        {
            DB_poco_assert_dbg(!getBinder().isNull());
    ...
    namespace Keywords
    {
        ...
        /// Convenience function for a more compact Binding creation.
        {
            ...
            DB_poco_static_assert(!IsConst<T>::VALUE);
        ...
        /// This function differs from use() in its value copy semantics.
        {
            return DBPoco::Data::Keywords::bind(t, "");
        }
...
#endif // DB_Data_Binding_INCLUDED
