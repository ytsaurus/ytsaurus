...
#ifndef DB_Data_AbstractBinder_INCLUDED
#define DB_Data_AbstractBinder_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        virtual void bind(std::size_t pos, const DBPoco::Int8 & val, Direction dir = PD_IN) = 0;
        /// Binds an Int8.

        virtual void bind(std::size_t pos, const std::vector<DBPoco::Int8> & val, Direction dir = PD_IN);
        /// Binds an Int8 vector.

        virtual void bind(std::size_t pos, const std::deque<DBPoco::Int8> & val, Direction dir = PD_IN);
        /// Binds an Int8 deque.

        virtual void bind(std::size_t pos, const std::list<DBPoco::Int8> & val, Direction dir = PD_IN);
        /// Binds an Int8 list.

        virtual void bind(std::size_t pos, const DBPoco::UInt8 & val, Direction dir = PD_IN) = 0;
        /// Binds an UInt8.

        virtual void bind(std::size_t pos, const std::vector<DBPoco::UInt8> & val, Direction dir = PD_IN);
        /// Binds an UInt8 vector.

        virtual void bind(std::size_t pos, const std::deque<DBPoco::UInt8> & val, Direction dir = PD_IN);
        /// Binds an UInt8 deque.

        virtual void bind(std::size_t pos, const std::list<DBPoco::UInt8> & val, Direction dir = PD_IN);
        /// Binds an UInt8 list.

        virtual void bind(std::size_t pos, const DBPoco::Int16 & val, Direction dir = PD_IN) = 0;
        /// Binds an Int16.

        virtual void bind(std::size_t pos, const std::vector<DBPoco::Int16> & val, Direction dir = PD_IN);
        /// Binds an Int16 vector.

        virtual void bind(std::size_t pos, const std::deque<DBPoco::Int16> & val, Direction dir = PD_IN);
        /// Binds an Int16 deque.

        virtual void bind(std::size_t pos, const std::list<DBPoco::Int16> & val, Direction dir = PD_IN);
        /// Binds an Int16 list.

        virtual void bind(std::size_t pos, const DBPoco::UInt16 & val, Direction dir = PD_IN) = 0;
        /// Binds an UInt16.

        virtual void bind(std::size_t pos, const std::vector<DBPoco::UInt16> & val, Direction dir = PD_IN);
        /// Binds an UInt16 vector.

        virtual void bind(std::size_t pos, const std::deque<DBPoco::UInt16> & val, Direction dir = PD_IN);
        /// Binds an UInt16 deque.

        virtual void bind(std::size_t pos, const std::list<DBPoco::UInt16> & val, Direction dir = PD_IN);
        /// Binds an UInt16 list.

        virtual void bind(std::size_t pos, const DBPoco::Int32 & val, Direction dir = PD_IN) = 0;
        /// Binds an Int32.

        virtual void bind(std::size_t pos, const std::vector<DBPoco::Int32> & val, Direction dir = PD_IN);
        /// Binds an Int32 vector.

        virtual void bind(std::size_t pos, const std::deque<DBPoco::Int32> & val, Direction dir = PD_IN);
        /// Binds an Int32 deque.

        virtual void bind(std::size_t pos, const std::list<DBPoco::Int32> & val, Direction dir = PD_IN);
        /// Binds an Int32 list.

        virtual void bind(std::size_t pos, const DBPoco::UInt32 & val, Direction dir = PD_IN) = 0;
        /// Binds an UInt32.

        virtual void bind(std::size_t pos, const std::vector<DBPoco::UInt32> & val, Direction dir = PD_IN);
        /// Binds an UInt32 vector.

        virtual void bind(std::size_t pos, const std::deque<DBPoco::UInt32> & val, Direction dir = PD_IN);
        /// Binds an UInt32 deque.

        virtual void bind(std::size_t pos, const std::list<DBPoco::UInt32> & val, Direction dir = PD_IN);
        /// Binds an UInt32 list.

        virtual void bind(std::size_t pos, const DBPoco::Int64 & val, Direction dir = PD_IN) = 0;
        /// Binds an Int64.

        virtual void bind(std::size_t pos, const std::vector<DBPoco::Int64> & val, Direction dir = PD_IN);
        /// Binds an Int64 vector.

        virtual void bind(std::size_t pos, const std::deque<DBPoco::Int64> & val, Direction dir = PD_IN);
        /// Binds an Int64 deque.

        virtual void bind(std::size_t pos, const std::list<DBPoco::Int64> & val, Direction dir = PD_IN);
        /// Binds an Int64 list.

        virtual void bind(std::size_t pos, const DBPoco::UInt64 & val, Direction dir = PD_IN) = 0;
        /// Binds an UInt64.

        virtual void bind(std::size_t pos, const std::vector<DBPoco::UInt64> & val, Direction dir = PD_IN);
        /// Binds an UInt64 vector.

        virtual void bind(std::size_t pos, const std::deque<DBPoco::UInt64> & val, Direction dir = PD_IN);
        /// Binds an UInt64 deque.

        virtual void bind(std::size_t pos, const std::list<DBPoco::UInt64> & val, Direction dir = PD_IN);
        ...
        void bind(std::size_t pos, const DBPoco::Dynamic::Var & val, Direction dir = PD_IN);
        /// Binds a Var.
...
#endif // DB_Data_AbstractBinder_INCLUDED
