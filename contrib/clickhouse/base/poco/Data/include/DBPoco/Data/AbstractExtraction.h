...
#ifndef DB_Data_AbstractExtraction_INCLUDED
#define DB_Data_AbstractExtraction_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        AbstractExtraction(DBPoco::UInt32 limit = Limit::LIMIT_UNLIMITED, DBPoco::UInt32 position = 0, bool bulk = false);
        ...
        void setLimit(DBPoco::UInt32 limit);
        /// Sets the limit.

        DBPoco::UInt32 getLimit() const;
        /// Gets the limit.
        ...
        bool isValueNull(const DBPoco::UTF16String & str, bool deflt);
    ...
    private:
        ...
        DBPoco::UInt32 _limit;
        DBPoco::UInt32 _position;
        bool _bulk;
    ...
    inline void AbstractExtraction::setLimit(DBPoco::UInt32 limit)
    {
        _limit = limit;
    }


    inline DBPoco::UInt32 AbstractExtraction::getLimit() const
    {
        return _limit;
    }
    ...
    inline DBPoco::UInt32 AbstractExtraction::position() const
    {
        return _position;
    }
    ...
    inline bool AbstractExtraction::isValueNull(const DBPoco::UTF16String & str, bool deflt)
    {
        return isStringNull(str, deflt);
    }
...
#endif // DB_Data_AbstractExtraction_INCLUDED
