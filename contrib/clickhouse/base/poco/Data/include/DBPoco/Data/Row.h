...
#ifndef DB_Data_Row_INCLUDED
#define DB_Data_Row_INCLUDED
...
namespace Data
{
    ...
    public:
        ...
        DBPoco::Dynamic::Var & get(std::size_t col);
        /// Returns the reference to data value at column location.

        DBPoco::Dynamic::Var & operator[](std::size_t col);
        /// Returns the reference to data value at column location.
    ...
    inline DBPoco::Dynamic::Var & Row::operator[](std::size_t col)
    {
        return get(col);
    }


    inline DBPoco::Dynamic::Var & Row::operator[](const std::string & name)
    {
