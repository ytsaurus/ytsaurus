...
#ifndef DB_Data_BulkExtraction_INCLUDED
#define DB_Data_BulkExtraction_INCLUDED


#include <vector>
#include "DBPoco/Data/AbstractExtraction.h"
#include "DBPoco/Data/Bulk.h"
#include "DBPoco/Data/Column.h"
#include "DBPoco/Data/Data.h"
#include "DBPoco/Data/Position.h"
#include "DBPoco/Data/Preparation.h"
...
namespace Data
{
    ...
    public:
        ...
        BulkExtraction(C & result, DBPoco::UInt32 limit, const Position & pos = Position(0))
            : AbstractExtraction(limit, pos.value(), true), _rResult(result), _default()
        {
            if (static_cast<DBPoco::UInt32>(result.size()) != limit)
                result.resize(limit);
        }

        BulkExtraction(C & result, const CValType & def, DBPoco::UInt32 limit, const Position & pos = Position(0))
    ...
    public:
        ...
        InternalBulkExtraction(C & result, Column<C> * pColumn, DBPoco::UInt32 limit, const Position & pos = Position(0))
    ...
    namespace Keywords
    {
        ...
        /// with std::vector bulk extraction support.
        {
            DBPoco::UInt32 size = static_cast<DBPoco::UInt32>(t.size());
            if (0 == size)
...
#endif // DB_Data_BulkExtraction_INCLUDED
