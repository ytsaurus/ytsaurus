...
#ifndef DB_Data_StatementImpl_INCLUDED
#define DB_Data_StatementImpl_INCLUDED
...
namespace Data
{
    ...
    {
    public:
        typedef DBPoco::SharedPtr<StatementImpl> Ptr;
    ...
    private:
        ...
        SharedPtr<InternalExtraction<C>> createExtract(const MetaColumn & mc)
        {
            ...
            return new InternalExtraction<C>(*pData, pCol, DBPoco::UInt32(currentDataSet()));
        }
        ...
        SharedPtr<InternalBulkExtraction<C>> createBulkExtract(const MetaColumn & mc)
        {
            ...
            return new InternalBulkExtraction<C>(
                *pData, pCol, static_cast<DBPoco::UInt32>(getExtractionLimit()), Position(static_cast<DBPoco::UInt32>(currentDataSet())));
        }
    ...
    {
        DB_poco_assert(_curDataSet < _extractors.size());
...
#endif // DB_Data_StatementImpl_INCLUDED
