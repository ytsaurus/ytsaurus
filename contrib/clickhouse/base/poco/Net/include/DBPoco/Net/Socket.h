...
#ifndef DB_Net_Socket_INCLUDED
#define DB_Net_Socket_INCLUDED
...
namespace Net
{
    ...
    public:
        ...
        static int select(SocketList & readList, SocketList & writeList, SocketList & exceptList, const DBPoco::Timespan & timeout);
        ...
        bool poll(const DBPoco::Timespan & timeout, int mode) const;
        ...
        void setSendTimeout(const DBPoco::Timespan & timeout);
        ...
        void setReceiveTimeout(const DBPoco::Timespan & timeout);
        /// Sets the send timeout for the socket.
        ///
        ...
        void setOption(int level, int option, const DBPoco::Timespan & value);
        /// Sets the socket option specified by level and option
        ...
        void getOption(int level, int option, DBPoco::Timespan & value) const;
        /// Returns the value of the socket option
        /// specified by level and option.
    ...
    inline bool Socket::poll(const DBPoco::Timespan & timeout, int mode) const
    {
    ...
    inline void Socket::setSendTimeout(const DBPoco::Timespan & timeout)
    {
        _pImpl->setSendTimeout(timeout);
    }


    inline DBPoco::Timespan Socket::getSendTimeout() const
    {
        return _pImpl->getSendTimeout();
    }


    inline void Socket::setReceiveTimeout(const DBPoco::Timespan & timeout)
    {
        _pImpl->setReceiveTimeout(timeout);
    }


    inline DBPoco::Timespan Socket::getReceiveTimeout() const
    {
    ...
    inline void Socket::setOption(int level, int option, const DBPoco::Timespan & value)
    {
        _pImpl->setOption(level, option, value);
    }
    ...
    inline void Socket::getOption(int level, int option, DBPoco::Timespan & value) const
    {
        _pImpl->getOption(level, option, value);
    }
    ...
    inline DB_poco_socket_t Socket::sockfd() const
    {
