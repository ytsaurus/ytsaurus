...
#ifndef DB_Net_NameValueCollection_INCLUDED
#define DB_Net_NameValueCollection_INCLUDED
...
namespace Net
{
    ...
    {
    public:
        typedef DBPoco::ListMap<std::string, std::string> HeaderMap;
...
#endif // DB_Net_NameValueCollection_INCLUDED
