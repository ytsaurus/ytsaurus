...
#ifndef DB_Util_AbstractConfiguration_INCLUDED
#define DB_Util_AbstractConfiguration_INCLUDED
...
namespace Util
{
    ...
    class Util_API AbstractConfiguration : public DBPoco::RefCountedObject
    ...
    public:
        ...
        DBPoco::BasicEvent<KeyValue> propertyChanging;
        ...
        DBPoco::BasicEvent<const KeyValue> propertyChanged;
        /// Fired after a property value has been changed
        /// or a property has been created.

        DBPoco::BasicEvent<const std::string> propertyRemoving;
        ...
        DBPoco::BasicEvent<const std::string> propertyRemoved;
    ...
    protected:
        ...
        /// implementation throws a DBPoco::NotImplementedException.
...
#endif // DB_Util_AbstractConfiguration_INCLUDED
