...
void SentryWriter::initializeInstance(DBPoco::Util::LayeredConfiguration & config)
{
...
SentryWriter::SentryWriter(DBPoco::Util::LayeredConfiguration & config)
{
    bool enabled = false;
...
void SentryWriter::initializeInstance(DBPoco::Util::LayeredConfiguration &) {}
SentryWriter * SentryWriter::getInstance() { return nullptr; }
void SentryWriter::resetInstance() {}

SentryWriter::SentryWriter(DBPoco::Util::LayeredConfiguration &) {}
