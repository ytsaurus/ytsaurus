...
public:
    ...
    public:
        ...
        bool tryLoad(const DBPoco::Util::AbstractConfiguration & config, const String & config_prefix);

        /// Load data and throw exception if something went wrong.
        void load(const DBPoco::Util::AbstractConfiguration & config, const String & config_prefix);
    ...
    private:
        ...
        static void loadImpl(const DBPoco::Util::AbstractConfiguration & config, const String & config_prefix, EncryptionMethod method, std::unique_ptr<Params>& new_params);
