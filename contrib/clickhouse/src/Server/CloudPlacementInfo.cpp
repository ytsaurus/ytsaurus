...
namespace
{
    ...
    String loadAvailabilityZoneFromFile(const DBPoco::Util::AbstractConfiguration & config)
    {
        ...
        DBPoco::trimInPlace(availability_zone_from_file);
...
void PlacementInfo::initialize(const DBPoco::Util::AbstractConfiguration & config)
try
{
