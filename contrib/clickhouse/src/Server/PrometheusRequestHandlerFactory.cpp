...
namespace
{
    ...
    void parseCommonConfig(const DBPoco::Util::AbstractConfiguration & config, PrometheusRequestHandlerConfig & res)
    {
    ...
    /// <events>true</events>
    /// <errors>true</errors>
    PrometheusRequestHandlerConfig parseExposeMetricsConfig(const DBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
    {
    ...
    QualifiedTableName parseTableNameFromConfig(const DBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
    {
    ...
    PrometheusRequestHandlerConfig parseRemoteWriteConfig(const DBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
    {
        PrometheusRequestHandlerConfig res;
    ...
    /// <table>db.time_series_table_name</table>
    PrometheusRequestHandlerConfig parseRemoteReadConfig(const DBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
    {
        PrometheusRequestHandlerConfig res;
    ...
    /// <table>db.time_series_table_name</table>
    PrometheusRequestHandlerConfig parseHandlerConfig(const DBPoco::Util::AbstractConfiguration & config, const String & config_prefix)
    {
