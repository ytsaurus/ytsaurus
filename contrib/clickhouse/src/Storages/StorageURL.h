...
public:
    ...
    static void setCredentials(DBPoco::Net::HTTPBasicCredentials & credentials, const DBPoco::URI & request_uri);

    static std::pair<DBPoco::URI, std::unique_ptr<ReadWriteBufferFromHTTP>> getFirstAvailableURIAndReadBuffer(
...
public:
    StorageURLSink(
        ...
        CompressionMethod compression_method,
        const HTTPHeaderEntries & headers = {},
        const String & method = DBPoco::Net::HTTPRequest::HTTP_POST);
