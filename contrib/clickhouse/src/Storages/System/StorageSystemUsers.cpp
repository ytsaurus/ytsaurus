...
void StorageSystemUsers::fillData(MutableColumns & res_columns, ContextPtr context, const ActionsDAG::Node *, std::vector<UInt8>) const
{
                       ...
                       const String default_database)
    {
        ...
        {
            DBPoco::JSON::Object auth_params_json;
            ...
            {
                DBPoco::JSON::Array::Ptr common_names = new DBPoco::JSON::Array();
                DBPoco::JSON::Array::Ptr subject_alt_names = new DBPoco::JSON::Array();
            ...
            DBPoco::JSON::Stringifier::stringify(auth_params_json, oss);
