...
{
    "VERSION_FULL", "ClickHouse 23.8.17.1",
    "VERSION_DESCRIBE", "v23.8.17.1-lts",
    "VERSION_INTEGER", "23008017",
    "SYSTEM", "Linux",
    "VERSION_GITHASH", "b80cac57eadd2bdad0ea44f54a262f5bd79e70b8",
    "VERSION_REVISION", "54478",
    "BUILD_TYPE", "MinSizeRel",
    "SYSTEM_PROCESSOR", "x86_64",
    "CMAKE_VERSION", "3.29.2",
    "C_COMPILER", "/var/empty/clang-wrapper-16.0.6/bin/clang",
    "C_COMPILER_VERSION", "16.0.6",
    "CXX_COMPILER", "/var/empty/clang-wrapper-16.0.6/bin/clang++",
    "CXX_COMPILER_VERSION", "16.0.6",
    "C_FLAGS", " --gcc-toolchain=./cmake/linux/../../contrib/sysroot/linux-x86_64 -fdiagnostics-color=always -Wno-enum-constexpr-conversion  -gdwarf-aranges -pipe -mssse3 -msse4.1 -msse4.2 -mpclmul -mpopcnt -fasynchronous-unwind-tables -ffile-prefix-map=.=. -falign-functions=32 -mbranches-within-32B-boundaries  -fdiagnostics-absolute-paths -Wframe-larger-than=65536 -Weverything -Wpedantic -Wno-zero-length-array -Wno-c++98-compat-pedantic -Wno-c++98-compat -Wno-c++20-compat -Wno-sign-conversion -Wno-implicit-int-conversion -Wno-implicit-int-float-conversion -Wno-ctad-maybe-unsupported -Wno-disabled-macro-expansion -Wno-documentation-unknown-command -Wno-double-promotion -Wno-exit-time-destructors -Wno-float-equal -Wno-global-constructors -Wno-missing-prototypes -Wno-missing-variable-declarations -Wno-padded -Wno-switch-enum -Wno-undefined-func-template -Wno-unused-template -Wno-vla -Wno-weak-template-vtables -Wno-weak-vtables -Wno-thread-safety-negative -Wno-enum-constexpr-conversion -Wno-unsafe-buffer-usage -Wno-deprecated-declarations -Wno-switch-default -Wno-shadow-uncaptured-local -Os -DNDEBUG",
    ...
    "LINK_FLAGS", " --gcc-toolchain=./cmake/linux/../../contrib/sysroot/linux-x86_64 --ld-path=/var/empty/lld-16.0.6/bin/ld.lld -Wl,--no-export-dynamic -Wl,--gdb-index -Wl,--build-id=sha1 -no-pie -Wl,-no-pie ",
