...
DBPoco::Timestamp DataPartStorageOnDiskBase::getLastModified() const
{
    ...
    bool allow_backup_broken_projection) const
{
    ...
    auto * log = &DBPoco::Logger::get("DataPartStorageOnDiskBase::backup");
    ...
    bool fsync_part_dir)
{
    ...
    {
        disk.setLastModified(from, DBPoco::Timestamp::fromEpochTime(time(nullptr)));
