...
friend HDFSBuilderWrapper createHDFSBuilder(const String & uri_str, const DBPoco::Util::AbstractConfiguration &);
...
private:
    void loadFromConfig(const DBPoco::Util::AbstractConfiguration & config, const String & prefix, bool isUser = false);
...
HDFSBuilderWrapper createHDFSBuilder(const String & uri_str, const DBPoco::Util::AbstractConfiguration &);
