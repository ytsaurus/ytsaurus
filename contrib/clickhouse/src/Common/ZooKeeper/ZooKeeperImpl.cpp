    ...
    DBPoco::Timespan connection_timeout)
{
    ...
    for (const auto & node : nodes)
    {
        try
        {
            const DBPoco::Net::SocketAddress host_socket_addr{node.host};
        ...
        catch (const DBPoco::Net::HostNotFoundException & e)
        {
