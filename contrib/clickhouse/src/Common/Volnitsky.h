        ...
        const UInt8 * pos, int offset, const UInt8 * begin, size_t size, Callback && putNGramBase)
    {
        ...
        else
        {
            ...
            if (UTF8::isContinuationOctet(chars.c1))
            {
                ...
                {
                    int l_u32 = DBPoco::Unicode::toLower(*u32);
                    int u_u32 = DBPoco::Unicode::toUpper(*u32);
            ...
            else
            {
                ...
                if (first_u32)
                {
                    first_l_u32 = DBPoco::Unicode::toLower(*first_u32);
                    first_u_u32 = DBPoco::Unicode::toUpper(*first_u32);
                }
                ...
                if (second_u32)
                {
                    second_l_u32 = DBPoco::Unicode::toLower(*second_u32);
                    second_u_u32 = DBPoco::Unicode::toUpper(*second_u32);
                }
