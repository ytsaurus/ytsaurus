...
namespace
{
    ...
    {
        // Copied from DBPoco::Util::ConfigurationView::translateKey():
        String result = key;
    ...
    bool isSameConfigurationImpl(const DBPoco::Util::AbstractConfiguration & left, const String & left_key,
                                 ...
                                 const std::unordered_set<std::string_view> * ignore_keys)
    {
        ...
        DBPoco::Util::AbstractConfiguration::Keys left_subkeys;
        DBPoco::Util::AbstractConfiguration::Keys right_subkeys;
...
bool isSameConfiguration(const DBPoco::Util::AbstractConfiguration & left, const DBPoco::Util::AbstractConfiguration & right)
{
    return isSameConfiguration(left, String(), right, String());
}

bool isSameConfiguration(const DBPoco::Util::AbstractConfiguration & left, const DBPoco::Util::AbstractConfiguration & right, const String & key)
{
...
bool isSameConfigurationWithMultipleKeys(const DBPoco::Util::AbstractConfiguration & left, const DBPoco::Util::AbstractConfiguration & right, const String & root, const String & name)
{
    if (&left == &right)
        return true;
