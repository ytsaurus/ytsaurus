...
{
    explicit ScopedEndOfReportDecorator(DBPoco::LoggerPtr log_) : log(std::move(log_)) { }
...
void printHeader(gwp_asan::Error error, uintptr_t fault_address, const gwp_asan::AllocationMetadata * allocation_meta, DBPoco::LoggerPtr log)
{
