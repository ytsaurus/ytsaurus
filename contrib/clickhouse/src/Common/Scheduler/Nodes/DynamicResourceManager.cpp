...
DynamicResourceManager::State::State(EventQueue * event_queue, const DBPoco::Util::AbstractConfiguration & config)
    : classifiers(config)
{
...
DynamicResourceManager::State::Node::Node(const String & name, EventQueue * event_queue, const DBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix)
...
void DynamicResourceManager::updateConfiguration(const DBPoco::Util::AbstractConfiguration & config)
{
