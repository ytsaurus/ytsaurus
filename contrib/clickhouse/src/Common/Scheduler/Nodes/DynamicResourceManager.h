...
public:
    ...
    void updateConfiguration(const DBPoco::Util::AbstractConfiguration & config) override;
...
private:
    ...
    struct State
    {
        ...
        State() = default;
        explicit State(EventQueue * event_queue, const DBPoco::Util::AbstractConfiguration & config);
    };
