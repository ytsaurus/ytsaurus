...
public:
    ...
    using Connection = DBPoco::Net::HTTPClientSession;
    using ConnectionPtr = std::shared_ptr<DBPoco::Net::HTTPClientSession>;

    /// can throw DBPoco::Net::Exception, DB::NetException, DB::Exception
