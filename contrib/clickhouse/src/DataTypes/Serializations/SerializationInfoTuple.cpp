...
DBPoco::JSON::Object SerializationInfoTuple::toJSON() const
{
    auto object = SerializationInfo::toJSON();
    DBPoco::JSON::Array subcolumns;
    for (const auto & elem : elems)
...
void SerializationInfoTuple::fromJSON(const DBPoco::JSON::Object & object)
{
