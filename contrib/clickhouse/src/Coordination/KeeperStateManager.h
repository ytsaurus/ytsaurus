...
public:
    ...
    ClusterUpdateActions getRaftConfigurationDiff(const DBPoco::Util::AbstractConfiguration & config, const CoordinationSettingsPtr & coordination_settings) const;
...
public:
    ...
    KeeperConfigurationWrapper parseServersConfiguration(const DBPoco::Util::AbstractConfiguration & config, bool allow_without_us, bool enable_async_replication) const;
};
