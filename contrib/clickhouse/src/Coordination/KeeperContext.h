...
public:
    ...
    void initialize(const DBPoco::Util::AbstractConfiguration & config, KeeperDispatcher * dispatcher_);
    ...
    void updateKeeperMemorySoftLimit(const DBPoco::Util::AbstractConfiguration & config);
...
private:
    ...
    void initializeFeatureFlags(const DBPoco::Util::AbstractConfiguration & config);
    void initializeDisks(const DBPoco::Util::AbstractConfiguration & config);

    Storage getRocksDBPathFromConfig(const DBPoco::Util::AbstractConfiguration & config) const;
    Storage getLogsPathFromConfig(const DBPoco::Util::AbstractConfiguration & config) const;
    Storage getSnapshotsPathFromConfig(const DBPoco::Util::AbstractConfiguration & config) const;
    Storage getStatePathFromConfig(const DBPoco::Util::AbstractConfiguration & config) const;
