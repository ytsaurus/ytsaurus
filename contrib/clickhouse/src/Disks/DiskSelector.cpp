...
void DiskSelector::initialize(
    const DBPoco::Util::AbstractConfiguration & config, const String & config_prefix, ContextPtr context, DiskValidator disk_validator)
{
...
DiskSelectorPtr DiskSelector::updateFromConfig(
    const DBPoco::Util::AbstractConfiguration & config, const String & config_prefix, ContextPtr context) const
{
    assertInitialized();
