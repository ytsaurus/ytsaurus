...
StoragePolicySelectorPtr StoragePolicySelector::updateFromConfig(const DBPoco::Util::AbstractConfiguration & config, const String & config_prefix, DiskSelectorPtr disks, Strings & new_disks) const
{
