...
bool isPlainStorage(ObjectStorageType type, const DBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix)
{
    return isCompatibleWithMetadataStorage(type, config, config_prefix, MetadataStorageType::Plain);
}

bool isPlainRewritableStorage(ObjectStorageType type, const DBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix)
{
...
ObjectStoragePtr createObjectStorage(
    ObjectStorageType type, const DBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix, Args &&... args)
{
...
S3::URI getS3URI(const DBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix, const ContextPtr & context)
{
