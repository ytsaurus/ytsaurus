...
void DiskObjectStorageRemoteMetadataRestoreHelper::restore(const DBPoco::Util::AbstractConfiguration & config, const std::string & config_prefix, ContextPtr context)
{
