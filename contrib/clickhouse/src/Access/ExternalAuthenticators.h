...
public:
    void reset();
    void setConfiguration(const DBPoco::Util::AbstractConfiguration & config, LoggerPtr log);
...
void parseLDAPRoleSearchParams(LDAPClient::RoleSearchParams & params, const DBPoco::Util::AbstractConfiguration & config, const String & prefix);
