...
public:
    ...
    void setCurrentAddress(const DBPoco::Net::SocketAddress & current_address);
    void setInitialUserName(const String & initial_user_name);
    void setInitialAddress(const DBPoco::Net::SocketAddress & initial_address);
    ...
    void loadOrReloadDictionaries(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void loadOrReloadUserDefinedExecutableFunctions(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void updateInterserverCredentials(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void setRemoteHostFilter(const DBPoco::Util::AbstractConfiguration & config);
    const RemoteHostFilter & getRemoteHostFilter() const;

    /// Storage of forbidden HTTP headers from config.xml
    void setHTTPHeaderFilter(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void updateKeeperConfiguration(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void updateUncompressedCacheConfiguration(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void updateMarkCacheConfiguration(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void updatePrimaryIndexCacheConfiguration(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void updateIndexUncompressedCacheConfiguration(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void updateIndexMarkCacheConfiguration(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void updateMMappedFileCacheConfiguration(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void updateQueryResultCacheConfiguration(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void updateQueryConditionCacheConfiguration(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void updateStorageConfiguration(const DBPoco::Util::AbstractConfiguration & config);
    ...
    void setDefaultProfiles(const DBPoco::Util::AbstractConfiguration & config);
...
struct HTTPContext : public IHTTPContext
{
    ...
    DBPoco::Timespan getReceiveTimeout() const override;

    DBPoco::Timespan getSendTimeout() const override;
