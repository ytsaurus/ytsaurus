...
public:
    ...
    void tryCreateEmbeddedDictionaries(const DBPoco::Util::AbstractConfiguration & config) const;
    ...
    void updateQueryCacheConfiguration(const DBPoco::Util::AbstractConfiguration & config);
