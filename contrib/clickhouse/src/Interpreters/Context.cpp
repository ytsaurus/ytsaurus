...
void Context::tryCreateEmbeddedDictionaries(const DBPoco::Util::AbstractConfiguration & config) const
{
...
void Context::updateQueryCacheConfiguration(const DBPoco::Util::AbstractConfiguration & config)
{
    std::lock_guard lock(shared->mutex);
