...
ExternalLoader::LoadableMutablePtr ExternalDictionariesLoader::createObject(
        const std::string & name, const DBPoco::Util::AbstractConfiguration & config,
...
bool ExternalDictionariesLoader::doesConfigChangeRequiresReloadingObject(const DBPoco::Util::AbstractConfiguration & old_config, const String & old_key_in_config,
                                                                         const DBPoco::Util::AbstractConfiguration & new_config, const String & new_key_in_config) const
{
...
void ExternalDictionariesLoader::updateObjectFromConfigWithoutReloading(IExternalLoadable & object, const DBPoco::Util::AbstractConfiguration & config, const String & key_in_config) const
{
...
DictionaryStructure
ExternalDictionariesLoader::getDictionaryStructure(const DBPoco::Util::AbstractConfiguration & config, const std::string & key_in_config)
{
