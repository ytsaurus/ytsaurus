...
bool SinkStream::WriteSizeVarint32(size_t value) {
  ...
  Y_ENSURE(value == narrowed_value);
  return WriteVarint32(narrowed_value);
}

bool SinkStream::Append(SinkStream* other) {
...
TBuffer&& SinkStream::ReleaseBuffer() {
...
//   <version><N><length1><length2>...<lengthN>
bool SinkStreamSet::CopyHeaderTo(SinkStream* header) {
