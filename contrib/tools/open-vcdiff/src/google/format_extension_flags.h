...
enum VCDiffFormatExtensionFlagValues {
  ...
  // If this flag is specified, dictionary will be included into output
  // according to sdch3dm specification (has no effect with VCD_FORMAT_JSON).
  VCD_FORMAT_SDCH3DM = 0x08,
};
