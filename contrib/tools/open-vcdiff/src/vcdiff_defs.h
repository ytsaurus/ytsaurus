...
const unsigned char VCD_SDCH3DM = 0x04;
...
// A window with final data. Only used with SDCH3DM, contains remaining
// dictionary fragments to be sent.
const unsigned char VCD_FINAL = 0x08;
