 ...
 private:
   ...
   public:
    void Apply(void* args_tuple, void* result) override {
      ...
      *static_cast<ResultT*>(result) =
          y_absl::apply(MockFnCaller<MockFnType, ResultT, ArgTupleT>{&mock_fn_},
  ...
  auto RegisterMock(SelfT&, base_internal::FastTypeIdType type)
    ...
    using WrappedFnType = y_absl::conditional_t<
        std::is_same<SelfT, ::testing::NiceMock<y_absl::MockingBitGen>>::value,
        ::testing::NiceMock<MockFnType>,
        y_absl::conditional_t<
            std::is_same<SelfT,
                         ::testing::NaggyMock<y_absl::MockingBitGen>>::value,
            ::testing::NaggyMock<MockFnType>,
            y_absl::conditional_t<
                std::is_same<SelfT,
                             ::testing::StrictMock<y_absl::MockingBitGen>>::value,
