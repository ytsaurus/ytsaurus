...
#ifndef Y_ABSL_CONTAINER_INTERNAL_NODE_SLOT_POLICY_H_
#define Y_ABSL_CONTAINER_INTERNAL_NODE_SLOT_POLICY_H_
...
#endif  // Y_ABSL_CONTAINER_INTERNAL_NODE_SLOT_POLICY_H_
