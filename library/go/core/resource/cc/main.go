...
func generate(w io.Writer, pkg string, blobs [][]byte, keys []string) {
	_, _ = fmt.Fprint(w, "// Code generated by go.ytsaurus.tech/library/go/core/resource/cc DO NOT EDIT.\n")
	_, _ = fmt.Fprintf(w, "package %s\n\n", pkg)
	_, _ = fmt.Fprint(w, "import \"go.ytsaurus.tech/library/go/core/resource\"\n")
