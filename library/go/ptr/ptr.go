...
func Int8(v int8) *int8 { return new(v) }

// Int16 returns pointer to provided value
func Int16(v int16) *int16 { return new(v) }
...
func Uint(v uint) *uint { return new(v) }

// Uint8 returns pointer to provided value
func Uint8(v uint8) *uint8 { return new(v) }

// Uint16 returns pointer to provided value
func Uint16(v uint16) *uint16 { return new(v) }

// Uint32 returns pointer to provided value
func Uint32(v uint32) *uint32 { return new(v) }
...
func Float32(v float32) *float32 { return new(v) }
...
func Byte(v byte) *byte { return new(v) }

// Rune returns pointer to provided value
func Rune(v rune) *rune { return new(v) }

// Complex64 returns pointer to provided value
func Complex64(v complex64) *complex64 { return new(v) }

// Complex128 returns pointer to provided value
func Complex128(v complex128) *complex128 { return new(v) }
...
func Duration(v time.Duration) *time.Duration { return new(v) }

// T returns pointer to provided value
// Deprecated: use builtin new(v) instead
func T[T any](v T) *T { return new(v) }
