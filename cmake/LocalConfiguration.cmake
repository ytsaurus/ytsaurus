...
if (MSVC)
  if ( "${CMAKE_BUILD_TYPE}" STREQUAL "" )
    if (YT_BUILD_WITH_STLPORT)
      SET( CMAKE_CXX_FLAGS "/I${CMAKE_SOURCE_DIR}/extern/STLport/stlport" CACHE STRING "C++ compiler flags" FORCE )
    endif()
  endif()

  if ( "${CMAKE_BUILD_TYPE}" STREQUAL "Release" )
    if (YT_BUILD_WITH_STLPORT)
      SET( CMAKE_CXX_FLAGS_RELEASE  "/I${CMAKE_SOURCE_DIR}/extern/STLport/stlport" CACHE STRING "C++ compiler flags" FORCE )
    endif()
  endif()

  if ( "${CMAKE_BUILD_TYPE}" STREQUAL "Debug" )
    if (YT_BUILD_WITH_STLPORT)
      SET( CMAKE_CXX_FLAGS_DEBUG "/I${CMAKE_SOURCE_DIR}/extern/STLport/stlport" CACHE STRING "C++ compiler flags" FORCE )
    endif()
  endif()

  if ( "${CMAKE_BUILD_TYPE}" STREQUAL "RelWithDebInfo" )
    if (YT_BUILD_WITH_STLPORT)
      SET( CMAKE_CXX_FLAGS_RELWITHDEBINFO "/I${CMAKE_SOURCE_DIR}/extern/STLport/stlport" CACHE STRING "C++ compiler flags" FORCE )
    endif()
  endif()
endif()
