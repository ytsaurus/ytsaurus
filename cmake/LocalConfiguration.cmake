...
if (MSVC)
  if ( "${CMAKE_BUILD_TYPE}" STREQUAL "" )
    if (YT_BUILD_WITH_STLPORT)
      SET( CMAKE_CXX_FLAGS "/I${CMAKE_SOURCE_DIR}/extern/STLport/stlport /EHsc /Zi /Od" CACHE STRING "C++ compiler flags" FORCE )
    else()
      SET( CMAKE_CXX_FLAGS "/EHsc /Zi /Od" CACHE STRING "C++ compiler flags" FORCE )
    endif()
    SET( CMAKE_EXE_LINKER_FLAGS "/DEBUG" CACHE STRING "Linker for executable flags" FORCE )
  endif()

  if ( "${CMAKE_BUILD_TYPE}" STREQUAL "Release" )
    if (YT_BUILD_WITH_STLPORT)
      SET( CMAKE_CXX_FLAGS_RELEASE  "/I${CMAKE_SOURCE_DIR}/extern/STLport/stlport /EHsc /O2" CACHE STRING "C++ compiler flags" FORCE )
    else()
      SET( CMAKE_CXX_FLAGS_RELEASE  "/EHsc /O2" CACHE STRING "C++ compiler flags" FORCE )
    endif()
    # SET( CMAKE_EXE_LINKER_FLAGS_RELEASE "/DEBUG" CACHE STRING "Linker for executable flags" FORCE )
  endif()

  if ( "${CMAKE_BUILD_TYPE}" STREQUAL "Debug" )
    if (YT_BUILD_WITH_STLPORT)
      SET( CMAKE_CXX_FLAGS_DEBUG "/I${CMAKE_SOURCE_DIR}/extern/STLport/stlport /EHsc /Zi /Od" CACHE STRING "C++ compiler flags" FORCE )
    else()
      SET( CMAKE_CXX_FLAGS_DEBUG "/EHsc /Zi /Od" CACHE STRING "C++ compiler flags" FORCE )
    endif()
    SET( CMAKE_EXE_LINKER_FLAGS "/DEBUG" CACHE STRING "Linker for executable flags" FORCE )
    SET( CMAKE_EXE_LINKER_FLAGS_DEBUG "/DEBUG" CACHE STRING "Linker for executable flags" FORCE )
  endif()

  if ( "${CMAKE_BUILD_TYPE}" STREQUAL "RelWithDebInfo" )
    if (YT_BUILD_WITH_STLPORT)
      SET( CMAKE_CXX_FLAGS_RELWITHDEBINFO "/I${CMAKE_SOURCE_DIR}/extern/STLport/stlport /EHsc /Zi /O2" CACHE STRING "C++ compiler flags" FORCE )
    else()
      SET( CMAKE_CXX_FLAGS_RELWITHDEBINFO "/EHsc /Zi /O2" CACHE STRING "C++ compiler flags" FORCE )
    endif()
    SET( CMAKE_EXE_LINKER_FLAGS "/DEBUG" CACHE STRING "Linker for executable flags" FORCE )
    SET( CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO "/DEBUG" CACHE STRING "Linker for executable flags" FORCE )
  endif()
endif()
