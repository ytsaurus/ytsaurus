...
$ cat ya.make:
    ...
    TEST_SRCS(
        mapreduce/yt/tests_core_http/run_yt_unittests.py # path to current script
    )
    PEERDIR(
    ...
    DEPENDS(
        ...
        mapreduce/yt/tests_core_http/native_new # path to unittest directory
    )
    END()
$ cat yt_unittest_conf.py
    BINARY_PATH = "mapreduce/yt/tests_core_http/native_new/test-native-interface" # path to unittest binary
"""
